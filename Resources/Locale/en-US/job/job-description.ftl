...
job-description-centcomoff = Act as an ambassador to the newest state-of-the-art space station in Black Mesa's fleet.
...
job-description-ertleader = Lead the Emergency Response Team in dealing with threats to Black Mesa assets.
