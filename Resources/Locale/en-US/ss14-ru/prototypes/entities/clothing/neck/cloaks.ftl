...
ent-ClothingNeckCloakNanotrasen = Black Mesa cloak
    .desc = A stately blue cloak to represent Black Mesa.
...
ent-ClothingNeckCloakAce = pilot's cloak
    .desc = Cloak awarded to Black Mesa's finest space aces.
...
ent-ClothingNeckCloakAroace = aeropilot's cloak
    .desc = Cloak awarded to Black Mesa's finest pilots on planets with inhabitable atmospheres.
...
ent-ClothingNeckCloakGay = multi-level marketing cloak
    .desc = This cloak is highly sought after in the Black Mesa Marketing Offices.
