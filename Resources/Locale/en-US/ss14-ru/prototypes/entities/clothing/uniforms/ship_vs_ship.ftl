...
ent-ClothingUniformJumpsuitRepairmanSyndie = syndicate repairman jumpsuit
    .desc = Functional, fashionable, and badass. Black Mesa's engineers wish they could look as good as this.
ent-ClothingUniformJumpsuitParamedicNT = paramedic jumpsuit
    .desc = A basic white & blue jumpsuit made for Black Mesa paramedics stationed in combat sectors.
