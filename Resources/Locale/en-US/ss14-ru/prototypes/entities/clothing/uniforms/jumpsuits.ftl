...
ent-ClothingUniformJumpsuitSecGrey = grey security jumpsuit
    .desc = A tactical relic of years past before Black Mesa decided it was cheaper to dye the suits red instead of washing out the blood.
ent-ClothingUniformSecurityTrooper = trooper uniform
    .desc = A formal uniform issued to the Black Mesa Troopers, usually it comes with a car.
ent-ClothingUniformJumpsuitWarden = warden's uniform
    .desc = A formal security suit for officers complete with Black Mesa belt buckle.
...
ent-ClothingUniformJumpsuitPyjamaSyndicateRed = red syndicate pyjamas
    .desc = For those long nights in perma.
ent-ClothingUniformJumpsuitNanotrasen = Black Mesa jumpsuit
    .desc = A stately blue jumpsuit to represent Black Mesa.
