...
ent-ClothingHeadHatSecurityTrooper = trooper hat
    .desc = A campaign hat for the Black Mesa Troopers. It's supposed to come with a case, too...
...
ent-ClothingHeadHatBeretCommand = command beret
    .desc = A beret with the Black Mesa logo. It has an aura of authority.
