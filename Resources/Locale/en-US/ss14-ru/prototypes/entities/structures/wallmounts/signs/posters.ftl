...
ent-PosterContrabandMissingGloves = Missing Gloves
    .desc = This poster references the uproar that followed Black Mesa's financial cuts toward insulated-glove purchases.
ent-PosterContrabandHackingGuide = Hacking Guide
    .desc = This poster details the internal workings of the common Black Mesa airlock. Sadly, it appears out of date.
ent-PosterContrabandRIPBadger = RIP Badger
    .desc = This seditious poster references Black Mesa's genocide of a space station full of badgers.
...
ent-PosterContrabandPower = Power
    .desc = A poster that positions the seat of power outside Black Mesa.
...
ent-PosterContrabandRebelsUnite = Rebels Unite
    .desc = A poster urging the viewer to rebel against Black Mesa.
...
ent-PosterLegitNanotrasenLogo = Black Mesa Logo
    .desc = A poster depicting the Black Mesa logo.
...
ent-PosterLegit50thAnniversaryVintageReprint = 50th Anniversary Vintage Reprint
    .desc = A reprint of a poster from 2505, commemorating the 50th Anniversary of Nanoposters Manufacturing, a subsidiary of Black Mesa.
ent-PosterLegitFruitBowl = Fruit Bowl
    .desc = Simple, yet awe-inspiring.
ent-PosterLegitPDAAd = PDA Ad
    .desc = A poster advertising the latest PDA from Black Mesa suppliers.
ent-PosterLegitEnlist = Enlist
    .desc = Enlist in the Black Mesa ERT reserves today!
...
ent-PosterLegitNoERP = No ERP
    .desc = This poster reminds the crew that Eroticism and Pornography are banned on Black Mesa stations.
...
ent-PosterLegitThereIsNoGasGiant = There Is No Gas Giant
    .desc = Black Mesa has issued posters, like this one, to all stations reminding them that rumours of a gas giant are false.
...
ent-PosterLegitVacation = Black Mesa Corporate Perks: Vacation
...
ent-PosterLegitRenault = Renault Poster
    .desc = Yap.
ent-PosterLegitNTTGC = Black Mesa Tactical Game Cards
    .desc = An advertisement for Black Mesa's TCG cards: BUY MORE CARDS.
