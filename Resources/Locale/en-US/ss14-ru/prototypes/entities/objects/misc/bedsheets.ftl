...
ent-BedsheetCaptain = captain's bedsheet
    .desc = It has a Black Mesa symbol on it, and was woven with a revolutionary new kind of thread guaranteed to have 0.01% permeability for most non-chemical substances, popular among most modern captains.
...
ent-BedsheetNT = NT bedsheet
    .desc = It has the Black Mesa logo on it and an aura of duty.
