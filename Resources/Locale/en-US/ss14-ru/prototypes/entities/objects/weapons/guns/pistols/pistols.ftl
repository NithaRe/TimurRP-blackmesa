...
ent-WeaponPistolMk58 = MK58
    .desc = A bog standard semi-automatic pistol chambered in thirty-five. Slim, simple, and accurate in the right hands, it's one of Black Mesa Small Arms' crown jewels and the most common sidearm in the free world. Feeds from .35 Auto pistol magazines.
ent-WeaponPistolN1984 = N1984
    .desc = A ridiculously overengineered hand cannon that fires a revolver cartridge. While the firerate is measured in malfunctions per second, it's become a sort of status symbol among the Black Mesa elite due to its sheer power and gaudy price tag. Feeds from .45 Magnum pistol magazines.
