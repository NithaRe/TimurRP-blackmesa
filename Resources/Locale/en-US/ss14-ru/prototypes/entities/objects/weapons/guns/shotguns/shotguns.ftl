...
ent-WeaponShotgunKammerer = Kammerer
    .desc = An old and faithful pump action, the Kammerer is cheap, light, and would probably still function if you left it in the burn chamber for a week. Popular for civilian use, and loved by Black Mesa for its minuscule price tag. Loads 7 rounds of 12 Gauge.
