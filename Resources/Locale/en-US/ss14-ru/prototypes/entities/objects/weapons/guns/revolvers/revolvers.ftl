...
ent-WeaponRevolverMateba = Mateba
    .desc = A rare and beautiful semi-automatic revolver. Provided only to the Black Mesa elite, the Mateba sports a unique barrel design that greatly reduces muzzle flip. Many have stared down the barrel of this gun, and even fewer have lived to tell the tale. Loads 6 rounds of .45 Magnum.
