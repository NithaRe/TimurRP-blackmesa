...
ent-WeaponLaserCarbine = laser carbine
    .desc = An ergonomic and light laser weapon favored by Black Mesa security teams because of its low capacity for structural damage.
...
ent-WeaponTaser = Taser
    .desc = A handheld stun weapon that fires two electrified darts at the target. Formerly used by Black Mesa security, though it's mostly been phased out.
