...
ent-BeachBall = beach ball
    .desc = The simple beach ball is one of Black Mesa's most popular products. 'Why do we make beach balls? Because we can! (TM)' - Black Mesa
ent-BalloonSyn = syndie balloon
    .desc = Handed out to the bravest souls who survived the "atomic twister" ride at Syndieland.
ent-BalloonNT = Black Mesa balloon
