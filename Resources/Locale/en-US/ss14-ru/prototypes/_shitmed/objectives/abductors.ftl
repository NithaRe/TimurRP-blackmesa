...
ent-AbductorVictimPristine = Ensure the station is pristine.
    .desc = The CEO of Black Mesa is coming! Ensure the station is in absolutely pristine condition.
...
ent-AbductorVictimSocialExperiment = It's all a lie.
    .desc = This is a secret social experiment conducted by Black Mesa. Convince the crew that this is the truth.
...
ent-AbductorVictimSaveAnimals = Save the animals.
    .desc = Black Mesa is abusing the animals! Save as many as you can!
