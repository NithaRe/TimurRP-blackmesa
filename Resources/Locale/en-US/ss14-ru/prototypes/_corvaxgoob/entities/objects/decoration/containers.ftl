...
ent-ShippingContainerNanotrasen = Black Mesa shipping container
    .desc = A standard-measure shipping container for bulk transport of goods. This one prominently features Black Mesa's logo, and so presumably could be carrying anything.
