...
ent-HijackShuttleObjective = Hijack emergency shuttle
    .desc = Leave on the shuttle free and clear of the loyal Black Mesa crew on board. Use ANY methods available to you. Syndicate agents, Black Mesa enemies, and handcuffed hostages may remain alive on the shuttle. Ignore assistance from anyone other than a support agent.
