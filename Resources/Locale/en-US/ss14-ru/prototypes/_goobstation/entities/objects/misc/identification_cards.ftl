...
ent-BlueshieldIDCard = blueshield officer ID card
    .desc = { ent-IDCardStandard.desc }
ent-NanotrasenRepresentativeIDCard = Black Mesa representative ID card
    .desc = { ent-IDCardStandard.desc }
ent-NanotrasenCareerTrainerIDCard = Black Mesa career trainer ID card
    .desc = { ent-IDCardStandard.desc }
ent-ExecutiveIDCard = executive access card
    .desc = Black Mesa employees are legally obligated to listen to someone with one of these. It's also capable of overriding access locks on most devices.
