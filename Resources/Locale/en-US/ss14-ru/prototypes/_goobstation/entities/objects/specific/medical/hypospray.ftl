...
ent-CentcommStimpack = centcomm advanced stimulant
    .desc = According to a Black Mesa funded study, it has zero addictive properties.
    .suffix = DO NOT MAP
...
ent-CentCommHypo = centcomm hypospray
    .desc = Reserved for Black Mesa's top doctors. It utilizes experimental bluespace technology.
