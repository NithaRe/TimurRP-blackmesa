...
ent-WeaponDisablerSyndicate = syndicate disabler
    .desc = A sleek disabler designed from a reverse-engineered Black Mesa prototype. While it lacks stopping power, it makes up for it with a self-recharging cell.
