ent-PosterLegitGoobWorkHard = Work Hard
    .desc = If you work hard enough, YOU could earn your very own Black Mesa Plunger Plus! Just be sure to survive long enough to redeem it!..
...
ent-PosterLegitGoobSuperMatter = Super-Matter
    .desc = Black Mesa's really getting creative with these motivational posters. Using the cause of death of thousands of people as a source of motivation? Brilliant. Now, if only it were actually effective...
...
ent-PosterLegitGoobSmokeBreak = Smoke Break
    .desc = A poster reminding you of the 'optimal' time for NanoTrasenapproved smoke breaks. They considered it long enough due to a security officer that alledgedly consumed about 500 cigarettes in 5 minutes. It has been shoddily edited to account for its recent increase by 10 minutes, as requested near-unanimously by the Station Captains who were polled. The color of the background is mildly irritating, but you're not too sure why.
...
ent-PosterLegitGoobNTRAdvert = NTRep Recruitment
    .desc = A poster advertising for open Black Mesa Representative positions, maybe you should apply
