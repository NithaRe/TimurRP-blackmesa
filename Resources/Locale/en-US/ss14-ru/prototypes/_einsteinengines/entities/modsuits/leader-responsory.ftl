...
ent-ClothingModsuitHelmetResponsoryLeader = Leader Responsory modsuit helmet
    .desc = A state-of-the-art helmet designed by Black Mesa for the Leader Responsory modsuit. It includes a built-in HUD.
ent-ClothingModsuitChestplateResponsoryLeader = Leader Responsory modsuit chestplate
    .desc = A state of the art chestplate designed by Black Mesa for the Leader Responsory modsuit. It incorporates powered servos to reduce the equipment load.
