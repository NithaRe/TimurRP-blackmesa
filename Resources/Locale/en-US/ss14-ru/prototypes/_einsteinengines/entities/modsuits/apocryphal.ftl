...
ent-ClothingModsuitHelmetApocryphal = Apocryphal modsuit helmet
    .desc = A state-of-the-art helmet designed by Black Mesa for the Apocryphal modsuit. It includes a built-in HUD.
ent-ClothingModsuitChestplateApocryphal = Apocryphal modsuit chestplate
    .desc = A state of the art chestplate designed by Black Mesa for the Apocryphal Modsuit. It incorporates powered servos to reduce the equipment load.
