...
ent-ClothingModsuitHelmetInquisitory = Inquisitory modsuit helmet
    .desc = A state-of-the-art helmet designed by Black Mesa for the Inquisitory modsuit. It includes a built-in HUD.
ent-ClothingModsuitChestplateInquisitory = Inquisitory modsuit chestplate
    .desc = A state of the art chestplate designed by Black Mesa for the Inquisitory modsuit. It incorporates powered servos to reduce the equipment load.
