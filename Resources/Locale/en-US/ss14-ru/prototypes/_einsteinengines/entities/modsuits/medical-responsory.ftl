...
ent-ClothingModsuitHelmetResponsoryMedical = Medical Responsory modsuit helmet
    .desc = A state-of-the-art helmet designed by Black Mesa for the Medical Responsory modsuit. It includes a built-in HUD.
ent-ClothingModsuitChestplateResponsoryMedical = Medical Responsory modsuit chestplate
    .desc = A state of the art chestplate designed by Black Mesa for the Medical Responsory modsuit. It incorporates powered servos to reduce the equipment load.
