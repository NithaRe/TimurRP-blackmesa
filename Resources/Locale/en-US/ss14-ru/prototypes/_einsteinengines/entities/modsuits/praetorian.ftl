...
ent-ClothingModsuitHelmetPraetorian = Praetorian modsuit helmet
    .desc = A state-of-the-art helmet designed by Black Mesa for the Praetorian modsuit.
ent-ClothingModsuitChestplatePraetorian = Praetorian modsuit chestplate
    .desc = A state of the art chestplate designed by Black Mesa for the Praetorian modsuit. It incorporates powered servos to reduce the equipment load.
