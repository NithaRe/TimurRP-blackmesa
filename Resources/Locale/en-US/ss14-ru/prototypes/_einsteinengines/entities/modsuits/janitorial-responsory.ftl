...
ent-ClothingModsuitHelmetResponsoryJanitorial = Janitorial Responsory modsuit helmet
    .desc = A state-of-the-art helmet designed by Black Mesa for the Janitorial Responsory modsuit. It includes a built-in HUD.
ent-ClothingModsuitChestplateResponsoryJanitorial = Janitorial Responsory modsuit chestplate
    .desc = A state of the art chestplate designed by Black Mesa for the Janitorial Responsory modsuit. It incorporates powered servos to reduce the equipment load.
