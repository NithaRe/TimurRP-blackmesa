...
ent-ClothingHeadEnvirohelmAncientVoid = NTSRA envirosuit helmet
    .desc = Made out of a modified NTSRA vacsuit, this helmet was Black Mesa's first-designed envirohelmet for Plasmamen.
...
ent-ClothingHeadEnvirohelmNanotrasenRepresentative = Black Mesa representative envirosuit helmet
    .desc = A black envirosuit helmet worn by the Black Mesa Representative, with black and gold accents.
