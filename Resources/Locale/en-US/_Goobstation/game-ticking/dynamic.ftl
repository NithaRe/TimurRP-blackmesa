...
dynamic-fax-threat-none =
    ...
    Although Black Mesa has a firm grip on security in your region, the valuable resources and strategic position aboard your station make it a potential target for infiltrations.
...
dynamic-fax-threat-low =
    Although your station lies within what is generally considered NanoTrasencontrolled space,
...
dynamic-fax-threat-mid =
    ...
    You are encouraged to elevate security as necessary to protect Black Mesa assets.
