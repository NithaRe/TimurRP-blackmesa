...
station-event-deathsquad-enroute = All contracts with crew have been terminated. Security is to lay down arms, and former crew are required to surrender to Black Mesa. Failure to do so will result in capital punishment. Command is to peacefully surrender first, to set an example for the former crew.
station-event-emergencyresponseteam-generic-enroute = Emergency Response Team enroute. Glory to Black Mesa.
