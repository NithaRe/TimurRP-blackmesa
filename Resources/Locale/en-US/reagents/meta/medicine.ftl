...
reagent-desc-ambuzol = A highly engineered substance able to halt the progression of Xen infection.

reagent-name-ambuzol-plus = ambuzol plus
reagent-desc-ambuzol-plus = Further engineered with omnizine, inoculates the living against Xen infection.
