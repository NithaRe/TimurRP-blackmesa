...
admin-smite-cluwne-description = Превращает в клувеня. Костюм нельзя снять, и персонал комплекса может беспрепятственно убивать их.
...
admin-smite-super-bonk-description = Заставляет цель удариться о каждый стол в комплексе и за её пределами.
...
admin-smite-super-bonk-lite-description = Заставляет цель удариться о каждый стол в комплексе и за её пределами. Прекращает действовать после смерти цели.
...
admin-trick-bar-job-slots-description = Закрывает все слоты должностей в комплексе, так что никто не сможет присоединиться.
admin-trick-locate-cargo-shuttle-description = Телепортирует вас прямо на грузовой шаттл комплекса, если он есть.
admin-trick-infinite-battery-description = Перенастраивает СМЭСы и подкомплекса на сетке/комплекса/карте на быструю автозарядку.
