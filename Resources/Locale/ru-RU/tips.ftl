...
tips-dataset-75 = Будучи капитаном, вы являетесь одной из самых приоритетных целей на станции. Всё — от Оперативников HECU, до предателей, которые хотят выкрасть уникальную вещь или вашу жизнь — всё это повод для беспокойства.
