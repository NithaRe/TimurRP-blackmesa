...
tips-dataset-24 = Каждый член персонала имеет в своем аварийном запасе экстренный медипен, содержащий эпинефрин и транексамовую кислоту.
...
tips-dataset-31 = Будучи предателем, вы можете использовать гарнитуру Aperture Science для поддержания связи с любым другим, купившим гарнитуру, предателем.
tips-dataset-32 = Будучи предателем, прослушивание важных каналов связи, таких как служба безопасности или инженернов, может дать ценные сведения. Имейте в виду, что это происходит в обоих направлениях - служба безопасности также может прослушивать канал связи Aperture Science!
...
tips-dataset-37 = Будучи предателем, помните, что поглотители энергии издают громкий звук и оповещают персонал после достаточно длительной работы. Попробуйте спрятать их в трудно-находимом месте или защитите область вокруг него, чтобы было труднее добраться.
...
tips-dataset-41 = Будучи Оперативником HECU, держитесь в группе! Пусть ваша броня и крепка, ваши соратники гораздо лучше справятся с вашим спасением: и огнём прикроют, и в укрытие лежащего тебя оттащат.
tips-dataset-42 = Будучи Оперативником HECU, помните, что связь имеет ключевое значение! Используйте свою рацию, чтобы поддерживать связь с вашими соратниками и координировать действия.
tips-dataset-43 = Будучи Оперативником HECU, помните о скрытном варианте. Руководитель Комплексау будет сложнее отбиться, если его застанет врасплох тот, кого он считает обычным пассажиром
...
tips-dataset-46 = Будучи утилизатором, всегда носите с собой GPS и записывайте координаты комплекса на случай, если ваш обломок затеряется в космосе.
...
tips-dataset-56 = Будучи грузчиком, помните, что вы можете заказывать оружие в экстренных ситуациях! Дополнительная огневая мощь часто может быть разницей между вами и другими членами персонала, живущими или умирающими.
...
tips-dataset-63 = Будучи шеф-поваром, вы можете тайно добавлять жидкости в свою еду. Как предатель, добавление небольшого количества аматоксина или другого яда может сильно навредить персоналу!
...
tips-dataset-70 = Будучи атмосферным техником, постарайтесь сопротивляться искушению использовать канистровые бомбы против Оперативников HECU, до тех пор, пока у вас не будет другого выхода. Этим вы можете нанести много ненужного урона по союзникам.
...
tips-dataset-75 = Будучи руководитель комплексаом, вы являетесь одной из самых приоритетных целей в комплексе. Всё — от Оперативников HECU, до предателей, которые хотят выкрасть уникальную вещь или вашу жизнь — всё это повод для беспокойства.
tips-dataset-76 = Будучи руководитель комплексаом, всегда носите с собой диск ядерной аутентификации и поисковый навигатор. Неплохим вариантом будет передать один из них другому главе, которому вы можете доверить его сохранность.
tips-dataset-77 = Будучи руководитель комплексаом, вы имеете полный доступ и абсолютный контроль над станцией, но это не означает, что если вы будете себя ужасно вести, это не приведет к бунту.
tips-dataset-78 = Будучи руководитель комплексаом, старайтесь быть активным и патрулировать станцию. Сидеть на мостике может быть соблазнительно, но в итоге вы только привлечете к себе больше внимания!
...
tips-dataset-81 = Будучи учёным, вы можете делать боргов, используя позитронные мозги. Они так же полезны, как новый член персонала.
...
tips-dataset-91 = Механизм самоуничтожение комплекса непобедим. Найдите диск вместо того, чтобы уничтожать его.
...
tips-dataset-106 = Противогаз Aperture Science блокирует свет от вспышек, это означает, что Оперативники HECU и другие сомнительные личности, которые носят его, не могут быть ослеплены.
...
tips-dataset-122 = Космическая комплекс 14 - это игра с открытым кодом! Если вы хотите что-то изменить или добавить простой предмет, попробуйте внести вклад в игру. Это не так сложно, как вы думаете.
