...
id-card-access-level-captain = Руководитель Комплекса
...
id-card-access-level-nuclear-operative = Оперативник HECU
id-card-access-level-syndicate-agent = Агент Aperture Science
id-card-access-level-central-command = Командование Комплекса
