...
steal-target-groups-captain-id-card = ID-карта руководителя комплекса
steal-target-groups-jetpack-captain-filled = джетпак руководителя комплекса
...
steal-target-groups-salvage-expeditions-computer-circuitboard = плата консоли Зен экспедиций
...
steal-target-groups-altarNanoTrasen = алтарь Black Mesa (любой)
steal-target-groups-nuclear-bomb = ядерная боеголовка
steal-target-groups-fax-machine-captain = факс дальнего действия руководителя комплекса
