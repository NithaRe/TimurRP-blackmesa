...
war-declarator-default-message = Пограничный отряд Aperture Science объявляет о своём намерении уничтожить станцию при помощи ядерного устройства и призывает персонал предпринять ничтожную попытку остановить их.
