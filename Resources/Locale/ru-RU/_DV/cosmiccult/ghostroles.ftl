...
roles-antag-rogue-ascended-objective = Судьба не должна быть отдана на волю случая. Используйте свои потусторонние силы, чтобы искажать сердца и умы тех, кто находится в комплексе.
ghost-role-information-rogue-ascended-name = Астральный вознесённый
ghost-role-information-rogue-ascended-description = Судьба не должна быть отдана на волю случая. Используйте свои потусторонние силы, чтобы искажать сердца и умы тех, кто находится в комплексе.
...
objective-condition-maligninfection-description = Ваше прикосновение может искажать разум. Пробудите чистейшую истину в { $count } существах в комплексе.
