...
construction-graph-tag-station-map-electronics = микросхема карты комплекса
...
construction-graph-tag-wallmount-substation-circuit-board = микросхема настенной подкомплекса
