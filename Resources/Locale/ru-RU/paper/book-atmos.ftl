book-text-atmos-distro =
    Сеть распределения, или же "дистра", жизненно важная для комплекса. Она отвечает за транспортировку воздуха с атмос-отдела по всей комплекса.
    
    Соответствующие трубы зачастую покрашены Выскакивающе-Приглушённым Синим, но безошибочный вариант определить их это использование т-лучевого сканера, чтобы отследить трубы подключённые к активным вентиляциям комплекса.
    ...
    Когда нужно думать над давлением дистры, есть несколько вещей которые нужно знать. Активные вентиляции регулируют давление в комплексе, так что пока всё работает стабильно, нет нужды в слишком высоком давлении дистры.
    
    Высокое давление дистры может сделать сеть "буфером" между газодобытчиками и вентиляциями, обеспечивая значительно количество воздуха, которое может использоваться для стабилизации давления в комплексе после разгерметизации.
    
    Низкое давление дистры уменьшит количество потерянного газа в случае разгерметизации сети, быстрый способ справится с загрязнением дистры. Так же это поможет уменьшить или предотвратить высокое давление в комплексе, в случае неполадок с вентиляциями.
...
book-text-atmos-waste =
    ...
    Вы можете распознать эти трубы по их Приятно-Тусклому Красному цвету или используя т-лучевой сканер, чтобы отследить какие трубы подсоединены к скрубберам в комплексе.
    ...
    Сеть отходов может помочь диагностировать атмосферные проблемы в комплексе. Высокое количество отходов может указывать на большую утечку, в то время как присутствие не отходов может указывать на ошибку в конфигурации скруббера либо проблему с физическим подсоединением. Если у газов высокая температура, это может означать пожар.
book-text-atmos-alarms =
    Воздушные сигнализации расположены по всей комплекса для доступа к настройке и наблюдении за локальной атмосферой.
...
book-text-atmos-vents =
    ...
    Активные вентиляции:
    Это самые распространённые вентиляции в комплексе. Они имеют встроенный насос и требуют электричества. По умолчанию они будут выкачивать газ из труб до 101 кПа. Однако они могут быть перенастроены, используя воздушные сигнализации. Так же они будут блокироваться, когда в комнате ниже 1 кПа для предотвращения выкачивания газов в космос.
