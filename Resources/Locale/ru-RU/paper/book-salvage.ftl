...
book-text-chemistry-insane =
    ...
    ВЫВОДЫ: ИГОРЬ ХИМИК
book-text-botanics = ** Практическое применение образцов флоры, встречаемых на территориях Black Mesa **
...
book-text-detective =
    ГЛАВА 1: МАЛЕНЬКИЙ ПЕРЕПОЛОХ НА БОЛЬШОЙ комплекса
    
    Эта комплекс тонула в преступности и грязи...
