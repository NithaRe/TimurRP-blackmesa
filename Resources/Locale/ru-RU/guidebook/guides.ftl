guide-entry-ss14 = комплекса и смены
guide-entry-engineering = Инженерное дело
guide-entry-construction = Строительство
guide-entry-expandingrepairingstation = Расширение и починка комплекса
...
guide-entry-janitorial = Уборка комплекса
...
guide-entry-security = Безопасность комплекса
...
guide-entry-nuclear-operatives = Оперативники HECU
