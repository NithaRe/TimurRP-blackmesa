...
badge-printer-unknown-job = Не указана
badge-printer-no-reason = не указана

badge-printer-no-selection = Не выбрано ни одного ключа.
badge-printer-too-many = Нельзя напечатать больше { $max } ключей за раз.
