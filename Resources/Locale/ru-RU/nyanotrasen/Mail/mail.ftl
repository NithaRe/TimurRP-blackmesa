...
command-mailto-no-teleporter-found = Не удалось сопоставить получателя ни с одним почтовым телепортером комплекса. Получатель может находиться вне комплекса.
