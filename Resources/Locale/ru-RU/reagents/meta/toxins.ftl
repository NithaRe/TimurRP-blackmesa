...
reagent-desc-romerol = Возбудитель Зен-заражения, необратимо изменяющий носителя без своевременного лечения и передающийся через его атаки. Обращайтесь с осторожностью.
