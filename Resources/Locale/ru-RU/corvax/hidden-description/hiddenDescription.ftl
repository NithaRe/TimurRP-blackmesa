...
corvax-hidden-desc-AgentIDCard-syndicate = [color=#e31735]Шпионская разработка Aperture Science. Позволяет копировать доступы с чужих ID карт, а также спокойно настраивать имя и должность владельца для систем опознавания станции.[/color]
