...
corvax-hidden-desc-AgentIDCard-syndicate = [color=#e31735]Шпионская разработка Aperture Science. Позволяет копировать доступы с чужих ID карт, а также спокойно настраивать имя и должность владельца для систем опознавания комплекса.[/color]
...
corvax-hidden-desc-Chameleon-syndicate = [color=#e31735]Имеет встроенную технологию Aperture Science, позволяющую менять внешний вид.[/color]
...
corvax-hidden-desc-ThievingGloves-syndicate = [color=#e31735]Разработка Aperture Science, нацеленная на незаметную кражу ценных предметов.[/color]
...
corvax-hidden-desc-SpiderCharge-ninja = [color=#14e397]Взрывы подобны солнцу. Свет ярко озарит гибель комплекса.[/color]
...
corvax-hidden-desc-Emag-syndicate = [color=#e31735]Универсальное хакерское устройство Aperture Science. Знаковый EMAG.[/color]
...
corvax-hidden-desc-ReinforcementRadioSyndicate-syndicate = [color=#e31735]Это маяк-телепортер для агента подкрепления Aperture Science. Ещё одна пара рук для преступлений.[/color]
corvax-hidden-desc-ReinforcementRadioSyndicateMonkey-syndicate = [color=#e31735]Это маяк-телепортер для макаки подкрепления Aperture Science. Ещё одна лапа для преступлений.[/color]
corvax-hidden-desc-ReinforcementRadioSyndicateCyborgAssault-syndicate = [color=#e31735]Это маяк-телепортер для штурмового борга Aperture Science. Машина для убийств и диверсий к вашим услугам.[/color]
...
corvax-hidden-desc-Telecrystal-syndicate = [color=#e31735]Валюта чёрного рынка Aperture Science. Позволяет покупать через редспейс пространство посредством аплинка различное нелегальное вооружение.[/color]
...
corvax-hidden-desc-BorgModuleOperative-syndicate = [color=#e31735]Модуль, в который входят монтировка, "Емаг" и пинпоинтер Aperture Science.[/color]
corvax-hidden-desc-BorgModuleEsword-syndicate = [color=#e31735]Модуль, в который входит двухклинковый энергетический меч и пинпоинтер Aperture Science.[/color]
corvax-hidden-desc-BorgModuleL6C-syndicate = [color=#e31735]Модуль, в который входит пулемёт L6C и пинпоинтер Aperture Science.[/color]
...
corvax-hidden-desc-ToolboxElectricalTurret-syndicate = [color=#e31735]Замаскированная под ящик инструментов, турель Aperture Science. Чтобы активировать развёртывание, необходимо ударить по ящику.[/color]
