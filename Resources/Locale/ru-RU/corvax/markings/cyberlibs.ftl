...
# Black Mesa
marking-CyberlimbRArmNanotrasen = Протез, правая рука (Black Mesa)
marking-CyberlimbLArmNanotrasen = Протез, левая рука (Black Mesa)
marking-CyberlimbRHandNanotrasen = Протез, кисть правой руки (Black Mesa)
marking-CyberlimbLHandNanotrasen = Протез, кисть левой руки (Black Mesa)
marking-CyberlimbRLegNanotrasen = Протез, правая нога (Black Mesa)
marking-CyberlimbLLegNanotrasen = Протез, левая нога (Black Mesa)
marking-CyberlimbRFootNanotrasen = Протез, правая стопа (Black Mesa)
marking-CyberlimbLFootNanotrasen = Протез, левая стопа (Black Mesa)
marking-CyberlimbTorsoNanotrasen = Протез, туловище (Black Mesa)
# Xion
