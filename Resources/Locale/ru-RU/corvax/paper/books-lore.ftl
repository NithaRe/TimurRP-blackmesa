...
book-clones-contents =
    ...
    Апофеозом всего этого стал “Туртельский Кризис” []Данные удалены[] года, когда несколько десятков клонов начали забастовку на малой научной комплекса под названием “Туртель”, находившейся на орбите Марса и занимавшейся секретными разработками компании Black Mesa (именно поэтому на ней было довольно большое количество клонов-персонала), работа комплекса была саботирована, а всему не клонированному персоналу было предложено эвакуироваться с неё. После того как все желающие эвакуировались, были и те, кто не являясь клонами, решили всё-таки остаться в комплексе тем самым выказав поддержку идеям клонов. Клоны и им сочувствующие смогли настроить аппаратуру комплекса на одну известную медиа-частоту и обратились по ней со своими требованиями, главным из которых было – предоставления всем клонам на территориях ОПЗ и объектах Black Mesa равных с обычными гуманоидами прав. В результате долгих и не очень продуктивных переговоров, Black Mesa не нашла ничего лучше, чем послать на станцию отряд зачистки, прибыв на место они устроили настоящую кровавую баню и когда уже подходили к мостику, были взорваны вместе со всей станцией одним из клонов-инженеров, который смог активировать ядерную боеголовку. Когда всё произошедшее стало достоянием широкой публики репутации и активам Black Mesa был нанесен огромный удар, а на многих планетах и станциях прошли митинги и забастовки в поддержку клонов. Массовые беспорядки нарастали, а СМИ лишь ещё больше подливали масло в огонь, так что ОПЗ приняла “Хартию Прав Клонов” и потребовала того же от Black Mesa, что последние поспешили и сделать.
...
book-faks-contents =
    ...
    Все данные в памяти проходят процедуру шифрования, а затем разбиваются на два потока данных по особому алгоритму, после чего оба потока получают код протокола разбиение на потоки данных, проходят процедуру расчёта и присваивания кода исправления ошибок и скремблирования, также каждому потоку данных прибавляется кодированный адрес комплекса и адрес конкретного факса в комплексе. Наконец эти потоки данных при помощи метода импульсного биполярного кодирования отправляются по системе дальней связи в пункт назначения. Все антенны дальней связи принимают сообщение с факса и считывают адрес комплекса, сравнивают со своим адресом и отбраковывают пакеты данных, если он не подходит, или принимают всю остальную посылку, если адрес совпадает. Далее специально выделенный ретранслятор отфильтровывает адрес комплекса и начинает рассылку на все факсы комплекса. Приёмное устройство факсов в свою очередь аналогичным образом производит сравнение адреса факса.
...
book-zp-contents =
    ...
    Коэффициенты по назначении комплекса:
    Административная комплекс – 2,0;
    Бизнес комплекс – 1,6;
    Исследовательская комплекс – 1,7;
    Экспериментальная комплекс – 1,8;
    Коммерческая комплекс – 1,3;
    Медицинская комплекс – 1,2;
    Оборонная комплекс – 1,7;
    Транспортная комплекс – 1,0.
    
    
    Коэффициенты по цели комплекса:
    Отдел напрямую занимается целью комплекса – 1,5;
    Отдел косвенно связан с целью комплекса – 1,25;
    Отдел не занимается целью комплекса – 1,0.
    ...
    Гибель вне комплекса – 0,1. Факт формируется после окончания смены.
    Гибель в комплексе или при исполнении должностных обязанностей – 0,2. Факт формируется после окончания смены.
    ...
    В случае гибели сотрудника и невозможности клонирования его заработная плата выплачивается ближайшим родственникам. Если таковых нет, удерживается в пользу корпорации. В случае возможности клонирования, коэффициент гибели признается равным 0,5. Страхование жизни и здоровья. Во время пребывания в комплексе каждый сотрудник и посетитель имеет право безвозмездного использования результатами труда других сотрудников комплекса и находящимися в раздатчиках ценностями (активами, продуктами, товарами). При получении инвалидности по итогу смены, компания назначает выплату на установку замены потерянной сотрудником конечности. По достижению старости компания выплачивает пенсионное вознаграждение - Ежемесячно 30% от среднемесячной заработной платы не работающим пенсионерам; ежемесячно 10% от среднемесячной заработной платы в дополнение к их заработной плате. Среднемесячная заработная плата рассчитывается, как сумма заработной платы за весь период работы, разделенная на количество полных месяцев работы на корпорацию.
    
    
    Прибыль комплекса
    
    Из результата деятельности комплекса на конец смены (результат/прибыль работы отдела снабжения) комплекс удерживает 75%. Квартирмейстер получает 3% от прибыли комплекса вне зависимости от участия в доставке грузов. Остальная часть распределяется в виде премии между сотрудниками комплекса, сформировавшими доход. Например, Атмосферный техник создал газ, грузчик отнес его в отдел снабжения, оба делят доход между собой. Второй пример - Утилизаторы притащили на станцию двигатели с обломка, которые были проданы. Утилизаторы делят доход между собой.
    
    
    Растраты
    
    Растратами признаются любое нецелевое использование средств, предоставленных корпорацией. Например, строительство космической техники в то время, когда цель – исследование артефактов. При таком использовании средств комплекса, виновный лишается всех коэффициентов выше единицы, а результат его деятельности признается собственностью корпорации. В любых нестандартных ситуациях специальная комиссия назначает дополнительные штрафные санкции.
    
    
    Дополнительное премирование
    
    Награждение медалью добавляет 50% к итоговой заработной плате. Быстрое окончание смены добавляет 50% к заработной плате руководителей отделов. Командование Комплекса корпорации может по своему усмотрению назначить дополнительную премию по итогам смены.
book-ussp-contents =
    Первые среди равных
...
book-umpor-contents =
    ...
    У Федерации нет отношений с Накамура Инжениринг, а с Black Mesa некоторое время были натянутые отношения из-за их тесного взаимодействия с Ноократией Эранта. Но сейчас отношения выправляются, и Умпорцы интересуются последними научными достижениями в некоторых важных для них областях.
book-nooc-contents =
