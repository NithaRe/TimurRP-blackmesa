...
station-goal-start = [color=#b8972d]███[/color][color=#1d7a1d]░███░░░░██░░░░[/color][color=#b8972d]                          ★ ★ ★[/color][color=#1d7a1d]
    ...
    ==================================================[bold]
                                             ЦЕЛЬ комплекса[/bold]
    ==================================================[bold]
    Цель смены комплекса { $station } — поддержание комплекса в рабочем состоянии.[/bold]
    
    Ваша комплекс должна провести в рабочем состоянии как минимум 2 часа.
    
    После прохождения минимального времени выполнения цели, вы в праве вызвать эвакуационный шаттл.
    Вы также можете закончить смену досрочно выполнив второстепенную задачу [bold]по желанию персонала[/bold].
...
station-goal-singularity =
    ...
    Все детали для цели должны быть заказаны или собраны в комплексе. Категорически запрещено использовать уже имеющиеся клетки или компоненты для постройки.
    
    Для успешного выполнения цели необходимо сделать запуск сингулярности.
    
    После окончания смены вся конструкция будет отсоединена от комплекса и транспортирована на другой объект.
...
station-goal-solar-panels =
    ...
    Требования:
    - Сеть должна состоять из минимум двух ветвей, расположенных на противоположных концах комплекса.
...
station-goal-artifacts =
    ...
    персонал комплекса должен найти минимум два артефакта любым способом, отличным от покупки.
    ...
    Каждый документ должен быть подтверждён печатью научного руководителя или руководителя комплекса. Артефакты с документацией должны быть доставлены на станцию центрального командования.
...
station-goal-bank =
    ...
    Хранилище должно быть размещено в космосе, отдельно от основной комплекса, защищено от метеоритов и иметь автономное питание.
    ...
    Допускается изменения по инициативе главного врача с подтверждением руководителя комплекса.
...
station-goal-zoo =
    ...
    Второстепенная цель — улучшение рекреации персонала комплекса.[/bold]
...
station-goal-mining-outpost =
    ...
    Аванпост должен быть размещен в космосе, отдельно от основной комплекса, защищён от метеоритов и иметь автономное питание, гравитацию и атмосферу.
...
station-goal-security =
    ...
    В будущем данная комплекс будет передислоцирована в сектор граничащий с небезопасным.
    ...
    Задачей Медицинского отдела является изготовление партии таблеток Эфедрина, дозировкой 20u каждая, в минимальном количестве 12 шт, с последующей передачей на хранение в защищенном контейнере Смотрителю комплекса.
    
    Задачей Службы Безопасности является проведение для каждого члена своего отдела тренировки на данной полосе с письменной фиксацией результатов. В результатах должно быть описано Имя и Фамилия сотрудника, а так же время за которое им была пройдена полоса. Лучшие сотрудники получат шанс на контракт о последующей работе на следующей смене данной комплекса. Результаты каждого сотрудника будет необходимо указать в отчете о состоянии цели.
...
station-goal-theatre =
    ...
    На данной комплекса пройдут переговоры с крупными компаниями для заключения партнёрских соглашений. Важно обеспечить тёплый приём гостей.
    ...
    В случае проведения тестового представления сервисный отдел комплекса будет вознагражден по прибытию на Станцию ЦК.
...
station-goal-ai =
    ...
    По окончанию строительства отсек должен быть отстыкован от комплекса и отправлен дрейфовать в космосе.
    
    Требования:
    1. Автономное питание на солнечных панелях или РИТЭГ, подключенное к СМЭС и Подкомплекса.
...
station-goal-botany =
    ...
    в комплексе или вблизи неё требуется построить три отсека с контролируемым климатом:
...
station-goal-bunker =
    ...
    Необходимо пристроить по комнате, далее именуемой как “бункер”, следующим отделам: Службы Безопасности, Медицинскому и Командному. В них персонал комплекса мог бы укрыться от последствий гиперэнергетических потоков.
...
station-goal-frame-repair =
    ...
    Второстепенная цель — окончание строительных работ в комплексе.[/bold]
    
    Необходимо достроить каждому отделу помещения, необходимые для успешной их работы. Также необходимо построить кухню и гидропонику для сервисного отдела, оружейную и место содержания заключённых для отдела службы безопасности, обеспечить свободный проход пассажиров комплекса до отбытия, без необходимости выхода в открытый космос.
    
    Для помощи в выполнении цели Командование Комплекса будет каждые пять минут высылать припасы на специальной посадочной площадке в центре комплекса.
...
station-goal-split-secure =
    ...
    персоналу необходимо обеспечивать безопасность субсектора Split на протяжении смены, чтобы комплекса Mayhen и Lumber могли успешно завершить свои задачи на смену.
...
station-goal-astra-repair =
    ...
    Второстепенная цель — восстановление заброшенной комплекса Vasilisk, находящейся в центральной части.[/bold]
    ...
    5. Главе персонала после завершения работ следует выставить на шлюзах необходимые доступы отделов и обеспечить свободное посещение сотрудниками комплекса зоопарка и музея.	
...
station-goal-bluespace-harvest =
    ...
    комплекс может тратить очки на своё усмотрение.
