...
station-goal-artifacts =
    ...
    Экипаж комплекса должен найти минимум два артефакта любым способом, отличным от покупки.
...
station-goal-bunker =
    ...
    Необходимо пристроить по комнате, далее именуемой как “бункер”, следующим отделам: Службы Безопасности, Медицинскому и Командному. В них экипаж комплекса мог бы укрыться от последствий гиперэнергетических потоков.
...
station-goal-split-secure =
    ...
    Экипажу необходимо обеспечивать безопасность субсектора Split на протяжении смены, чтобы комплекса Mayhen и Lumber могли успешно завершить свои задачи на смену.
