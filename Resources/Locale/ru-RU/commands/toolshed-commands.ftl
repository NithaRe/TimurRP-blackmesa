...
command-description-jobs-jobs = Отображает список всех профессий в комплексе.
command-description-jobs-job = Отображает информацию о конкретной профессии в комплексе.
...
command-description-stations-config = Отображает конфигурацию для указанной комплекса, если она есть.
command-description-stations-addgrid = Добавляет грид к указанной комплекса.
command-description-stations-rmgrid = Удаляет грид из указанной комплекса.
command-description-stations-rename = Переименовывает указанную станцию.
command-description-stations-largestgrid = Отображает самый большой грид на указанной комплекса, если она есть.
command-description-stations-rerollBounties = Сбрасывает все текущие награды в комплексе и выбирает новые.
command-description-stationevent-lsprob = Показывает вероятность различных событий комплекса из всего пула.
command-description-stationevent-lsprobtime = Показывает вероятность событий в комплексе в зависимости от длительности раунда.
command-description-stationevent-lsprobtheoretical = Для прототипа BasicStationEventScheduler, количества игроков и времени раунда показывает вероятность событий в комплексе.
command-description-stationevent-prob = Отображает вероятность одного события комплекса из всего пула.
...
command-description-jobboard-completeJob = Завершает указанное задание на доске утилизаторских объявлений для комплекса.
