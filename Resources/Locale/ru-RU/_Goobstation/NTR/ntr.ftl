...
ntr-executive-monitoring-name = Плата сервера мониторинга персонала
ntr-executive-monitoring-desc = Плата для систем мониторинга персонала. Обращайтесь с осторожностью, ведь замена стоит дорого.
