...
spellbook-event-dimension-shift-desc =
    Смещает измерение комплекса, делая космическую атмосферу безопасной для гуманоидов, но всё ещё непригодной для дыхания. Полезно, если вы боитесь космоса, но это также мешает экипажу умирать в нём.
