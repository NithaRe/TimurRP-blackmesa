...
spellbook-event-dimension-shift-desc =
    Смещает измерение комплекса, делая космическую атмосферу безопасной для гуманоидов, но всё ещё непригодной для дыхания. Полезно, если вы боитесь космоса, но это также мешает персоналу умирать в нём.
    Срабатывает немедленно после покупки.
    Не подлежит возврату.
spellbook-event-global-tile-toggle-name = Глобальное смещение плиток
spellbook-event-global-tile-toggle-description = комплекса это не понравится.
...
spellbook-bottle-tickles-desc =
    ...
    Реакция персонала, однако, может быть весьма негативной.
