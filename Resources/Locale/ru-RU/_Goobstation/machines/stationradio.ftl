...
signal-port-description-radio-server = Вход радиосервера, соединяемый с радиоустановкой для проигрывания музыки в комплексе!
vinyl-popout-no-station = Пластинка выскакивает! Вы находитесь не в комплексе.
