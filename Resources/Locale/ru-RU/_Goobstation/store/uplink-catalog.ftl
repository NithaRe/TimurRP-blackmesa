...
uplink-hardsuit-cybersun-dreadnought-desc = Невероятно прочный боевой костюм из гипер-блюспейс улучшенной пластали — почти непробиваемая стена. Но наденут его лишь самые безумные фанатики Aperture Science. Из-за веса костюм нужно затягивать до боли, застежки впиваются в кожу и не могут быть сняты без повреждения кожи.

# Misc

uplink-gondola-name = Ящик с гондолой
uplink-gondola-desc = Ящик со стандартной гондолой.
uplink-operative-radio-name = Телепорт Оперативника HECU
uplink-operative-radio-desc = Рация низкого качества для вызова Оперативника HECU. Кнопка выключения отсутствует — покупай, если готов к веселью. Имеет базовое снаряжение Оперативника HECU.
...
uplink-signaller-desc = Устройство для дистанционной передачи сигналов на любой дикомплекса. Можно связать с другими предметами через мультитул или сетевой конфигуратор.

# bang bang pew pew eat it up i gota go

uplink-miniature-energy-crossbow-name = Миниатюрный энергетический арбалет
uplink-miniature-energy-crossbow-desc = Энергетический арбалет Aperture Science — малый, бесшумный и смертоносный.
...
uplink-contractor-baton-desc = Компактная дубинка для Aperture Scienceовских наёмников. Наносит лёгкие электрические разряды, которые могут временно оглушать цель и повреждать роботов.
...
uplink-estoc-desc = Штурмовая винтовка с оптическим прицелом, рассчитана для боя на значительной дикомплекса.
uplink-syndicate-disabler-name = Станнер Aperture Science
uplink-syndicate-disabler-desc = Продвинутый станнер, созданный на основе прототипа Black Mesa. Хоть ему и не хватает мощности, это компенсируется самозаряжающейся батареей.
...
uplink-bulk-mosin-name = Aperture Scienceский ящик с винтовками
uplink-bulk-mosin-desc = 10 винтовок эпохи WW4 для вас, друзей и вашей кошки. Экономьте 40% при оптовой покупке!
uplink-whimsy-bundle-name = Комплект радости и веселья Aperture Science
...
uplink-second-skin-desc =
    Улучшенная версия устройства Black Mesa службы безопасности, которая не вызывает отвращения и не разъедает материалы роботов.
...
uplink-helmet-swat-name = Шлем спецназа Aperture Science
...
uplink-pizza-bomb-desc = Первоначально разработана террористами, теперь используется Aperture Science для устранения высокоприоритетных целей. Не открывайте до взрыва!
...
uplink-cddisksyndicate-name = CD "Реклама Aperture Science"
uplink-cddisksyndicate-desc = 102.9 Aperture Science радио
uplink-cddisknumber-name = CD "Номер комплекса"
uplink-cddisknumber-desc = Вызовите угрозу, чтобы отвлечь внимание комплекса... Удачи проиграть это полностью.
#Contractor
...
uplink-customboard-name = Экспериментальная плата законов Aperture Science
...
uplink-tcminer-desc = Содержит плоский комплект для сборки майнера телекристаллов — очень шумной машины, использующей редспейс-блокчейн-технологию для генерации телекристаллов каждые 10 секунд при наличии питания. Требует 10 кВт энергии и подключения к основной сети комплекса. Мультитул в комплект не входит.
uplink-syndiedrobe-name = СиндиШкаф
uplink-syndiedrobe-desc = Торговый автомат, заполненный одеждой с символикой Aperture Science. Простой, строгий и чётко красно-черный. Предлагает оперативникам одеться в стиле Aperture Science.
uplink-bloodred-casette-name = Плеер Aperture Science
...
uplink-undetermined-bundle-desc = Ящик с тремя случайными наборами, из которых можно выбрать один. Гарантированно содержит ключ шифрования Aperture Science.
