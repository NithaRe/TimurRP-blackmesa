...
job-description-diplomat = Представляйте Командование Комплекса, управляйте отношениями с другими фракциями в комплексе. Разбирайтесь с проблемами, которые, скорее всего, вызвал Капитан.
