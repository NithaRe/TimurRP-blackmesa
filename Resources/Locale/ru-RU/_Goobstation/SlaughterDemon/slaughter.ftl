...
slaughter-role-greeting =
    ...
    Вы можете использовать значок "Кровавый прыжок", находясь на кровавых лужах, чтобы перемещаться через них, появляясь и исчезая в комплексе по своему желанию.
