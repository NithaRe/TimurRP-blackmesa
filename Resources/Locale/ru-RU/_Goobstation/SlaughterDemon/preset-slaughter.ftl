...
objective-condition-slaughter-devour-desc = Поглотите { $count } членов персонала.
...
objective-condition-hug-and-tickle-desc = персонал так в восторге, что разбрызгивает вишнёвое варенье повсюду! Хорошо, что вы обожаете варенье! Ура!
...
objective-spare-crew-title = Пощадите нескольких членов персонала, чтобы они кровоточили перед финальным ударом.
