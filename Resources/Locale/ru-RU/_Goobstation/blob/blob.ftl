...
blob-alert-out-off-station = Блоб был удалён, так как находился вне комплекса!
# Announcment
blob-alert-recall-shuttle = Аварийный шаттл не может быть вызван, пока в комплексе присутствует биологическая угроза 5-го уровня.
blob-alert-detect = Подтверждена вспышка биологической угрозы 5-го уровня в комплексе. Все сотрудники обязаны сдерживать угрозу.
blob-alert-critical = Критический уровень биологической угрозы. На станцию отправлены коды ядерной аутентификации. Командование Комплекса приказывает всем оставшимся членам персонала активировать механизм самоуничтожения.
blob-alert-critical-NoNukeCode = Критический уровень биологической угрозы. Командование Комплекса приказывает оставшимся членам персонала укрыться и ожидать помощь.
...
blob-carrier-role-rules =
    ...
    Используйте это время, чтобы найти безопасное место в комплексе. Учтите, что после превращения вы будете очень слабы.
blob-carrier-role-greeting = Вы — носитель блоба. Найдите укромное место в комплексе и превратитесь в блоба. Превратите станцию в массу, а её обитателей в своих слуг. Мы все — блобы.
# Verbs
...
# Greeting
blob-role-greeting =
    Вы — блоб, паразитическое космическое существо, способное уничтожать целые комплекса.
