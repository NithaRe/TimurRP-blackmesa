job-name-warden = оператор изо.сектора
job-name-security = оперативник Ковак
job-name-cadet = стажёр Ковак
job-name-hos = глава отдела подавления
job-name-detective = детектив
job-name-brigmedic = медик силового сектора
job-name-borg = борг
...
job-name-captain = руководитель комплекса
...
job-name-passenger = персонал без квалификации
...
job-name-syndicate = Aperture Science
...
JobBotanist = ботаник
JobBoxer = боксёр
JobCaptain = руководитель комплекса
...
JobScientist = учёный
JobSecurityCadet = стажёр Ковак
JobSecurityOfficer = оперативник Ковак
...
JobWarden = оператор изоляционного сектора
