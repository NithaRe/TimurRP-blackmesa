...
job-description-chef = Кормите экипаж комплекса разными блюдами, разделывайте мёртвых животных так, чтобы аммиак не просачивался, и помогайте поддерживать бар в оживлённом состоянии.
...
job-description-ertchaplain = Проследите за тем, чтобы последнее право экипажа комплекса было соблюдено.
...
job-description-ertmedic = Убедитесь, что экипаж комплекса жив и здоров.
