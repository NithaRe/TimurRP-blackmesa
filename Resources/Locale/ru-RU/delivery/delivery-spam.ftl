...
-delivery-headerNanoTrasen = [color=blue]
    ╔══════════════════╗
    ║███░███░░░░██░░░░░║
    ║░██░████░░░██░░░░░║
    ║░░█░██░██░░██░█░░░║
    ...
    ║░░░░██░░░████░███░║
    ╚══════════════════╝[/color]
-delivery-headerNanoTrasen-alternate-timeline = [color=red]
    ╔══════════════════╗
    ║███░███░░░░██░░░░░║
    ║░██░████░░░██░░░░░║
    ║░░█░██░██░░██░█░░░║
...
delivery-spam-reasons-to-choseNanoTrasen =
    { -delivery-headerNanoTrasen }
    
    { "[head=2]ТОП ТРИ ПРИЧИНЫ НЕКОМПЕТЕНТНОСТИ Aperture Science[/head]" }
    ...
    ИХ МИРНЫЕ СОТРУДНИКИ УЯЗВИМЫ К ПУЛЯМ! ПОВЕРЬТЕ, МЫ ПРОВЕРЯЛИ! В ОТЛИЧИЕ ОТ СОТРУДНИКОВ Black Mesa, МИРНЫЕ СОТРУДНИКИ Aperture Science ДОХНУТ ОТ ОДНОЙ ПУЛИ В ЛОБ! А ПУЛИ У НАС ЕСТЬ!
...
delivery-spam-reasons-to-choose-syndicate =
    ...
    { "[head=2]ТОП ТРИ ПРИЧИНЫ НЕКОМПЕТЕНТНОСТИ Black Mesa[/head]" }
...
delivery-spam-tired-of-science = [head=3]Учёные будет ОБОЖАТЬ вас за это!!!
    ...
    { "[bold]ВЫ[/bold] устали от научного отдела вашим комплексом, который только взрывается и не занимается [bold]РЕАЛЬНОЙ[/bold] наукой??" }
    ...
    - Шаг 5: Наши курьеры из Паукберис будут доставлять вашим комплексом один (1) техдиск в неделю.
...
delivery-spam-free-all-access = [head=3]Вы когда-нибудь мечтали о [italic][color=green]Бесссплатном [bold]Полном доссступе!?!?[/bold][/color][/italic][/head]
    ...
    Всё что нужно сделать - это позвонить по номеру [color=blue]8-800-ГОУР-ЛЕКССС[/color] и назвать АЙДИ# своей комплекса!!!
    После этого мы удалённо сссвяяжемся с кошельком отдела снабжения вашейсскомплекса, и ссспишем всего три [italic]МАЛЕНЬКИХ[/italic] платежа, чтобы вы смогли получить
    { "[head=2][color=green] [bolditalic] БЕСССПЛАТНЫЙ ПОЛНЫЙ ДОСТУП!!!!!!!!!![/bolditalic][/color][/head]" }
    
    
    { "[color=gray]" }
    { "[bullet/]Примечание: Айди комплекса должено быть указано в формате \"NT/NX - ###\"" }
    { "[bullet/]Примечание: Платежи, осуществляемые через отдел снабжения комплекса клиента, составляют примерно 5000 кредитов за транзакцию, не считая индивидуальных сборов за обработку и НДС" }
...
delivery-spam-centcomm-retribution = [color=red] ОФИЦИАЛНОЕ СООБЩЕНИЕ ГЛАВЫ [color=blue]НАНАТРАЗЕН[/color][/color]
    ...
    если вы не хотите чтобы эта комплекс была обьявлена Нерентабельной в глазах
    { "[head=2][italic] Нашей Великой и Славной [color=blue]Black Mesa[/color][/head]" }
    То вы обязаны организовать поставку золотых слитков стандартна [color=blue]нт[/color] в стопках образца [color=blue]Нт[/color] в торговый пост вашим комплексом в течение 5 Стандартных рабочих [color=blue]нТ[/color] смен.
...
delivery-spam-alternate-timeline =
    { -delivery-headerNanoTrasen-alternate-timeline }
    
    { "[head=2]Это официальное уведомление [color=red]Начальника Службы Безопасности[/color] Космической комплекса 15 Black Mesa.[/head]" }
    
    Кому бы ни попало это письмо... Я сержант Ригель, начальник службы безопасности. Нам срочно нужно подкрепление.
    
    Наша комплекс подверглась атаке Оперативников HECU, данное послание было отправлено в дестабилизированную блюспейс-аномалию, созданную нашим[color=purple]Главой исследований[/color].
...
delivery-spam-narsie-cult = [color=#134975][head=2]Дети Нар'Си[/head][/color]
    ...
    Если вы ответили «Да» на любой из этих вопросов, то свяжитесь с нашим представителем уже сегодня! Наши последователи есть на комплексх по всей галактике и с радостью примут вас в нашу отару. Станьте одним из кинжалов, что помогут приветствовать Геометра Крови в наш мир, дабы все познали его блаженство!!
...
delivery-spam-rage-cage = [color=#aaaaaa]▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀[/color]
    ...
    Скрытая в глубинах комплекса Black Mesa, запатентованная [color=#FF0000][bold]КЛЕТКА ЯРОСТИ[/bold][/color]! Эта электрифицированная арена создана только для сильнейших, в [color=#FF0000][bold]КЛЕТКЕ ЯРОСТИ[/bold][/color] трусы отделяются от воинов, салаги — от солдат, а неудачники — от победителей.
    ──────────────────────────────────────────
    ...
    ──────────────────────────────────────────
    Никакого оружия, никакой брони — только чистая незамутнённая [bold]ДРАКА[/bold]. Не будь [bold]СЛАБАКОМ[/bold]. Завоюйте славу самого робастного бойца своей комплекса в [color=#FF0000][bold]КЛЕТКЕ ЯРОСТИ[/bold][/color] уже сегодня!
...
delivery-spam-parents-need-money = [bold]Привет Малыш,[/bold]
    ...
    отправь их сюда:
    50192 Спесс Лейн
    комплекс Сити, Ингиус 40195-243
    Гамма-Квадрант
    Система Гуилимин
...
delivery-spam-voyage-advertisement = [head=2]Присоединяйтесь к нам на первом рейсе...[/head]
    ...
    ░▀░▀░▀░▀░░░▀░░░▀▀▀░▀░▀░▀░▀░▀░▀░▀▀▀░▀▀▀░▀░░
     ...
     { "[head=3]Исследуйте руины Агатара***, теперь открытые для публики благодаря помощи лучших учёных Black Mesa. Все тайны древней Агатарской цивилизации раскопаны и выставлены для вашего удовольствия![/head]" }
