...
delivery-spam-alternate-timeline =
    ...
    { "[head=2]Это официальное уведомление [color=red]Начальника Службы Безопасности[/color] Космической станции 15 Black Mesa.[/head]" }
    
    Кому бы ни попало это письмо... Я сержант Ригель, начальник службы безопасности. Нам срочно нужно подкрепление.
    
    Наша станция подверглась атаке Оперативников HECU, данное послание было отправлено в дестабилизированную блюспейс-аномалию, созданную нашим[color=purple]Главой исследований[/color].
...
delivery-spam-rage-cage = [color=#aaaaaa]▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀[/color]
    ...
    Скрытая в глубинах станции Black Mesa, запатентованная [color=#FF0000][bold]КЛЕТКА ЯРОСТИ[/bold][/color]! Эта электрифицированная арена создана только для сильнейших, в [color=#FF0000][bold]КЛЕТКЕ ЯРОСТИ[/bold][/color] трусы отделяются от воинов, салаги — от солдат, а неудачники — от победителей.
    ──────────────────────────────────────────
