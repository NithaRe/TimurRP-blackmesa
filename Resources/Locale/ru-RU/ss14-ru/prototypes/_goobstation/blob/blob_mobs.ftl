...
ent-MobBlobBlobbernaut = Блоббернаут
    .desc = Джаггернаут, но блоб! Когда персонал комплекса питает к тебе лютую ненависть, с помощью таких сильных союзников можно устроить блицкриг — если заранее продумать план.
