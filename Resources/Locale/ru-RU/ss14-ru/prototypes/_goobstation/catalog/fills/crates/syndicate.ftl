...
ent-CrateCybersunMaulerBundle = комплект Cybersun Маулер
    ...
    .suffix = Заполненный
ent-CrateSyndicateBulkMosin = ящик с массовыми винтовками Aperture Science
...
ent-CratePizzaParty = доставка пиццы в случае катастрофы
    ...
    .suffix = Бомбы
ent-CrateSyndicateUndetermined = ящик с неопределённым комплектом Aperture Science
    .desc = Содержит комплект Aperture Science. Какой именно — ещё неизвестно.
