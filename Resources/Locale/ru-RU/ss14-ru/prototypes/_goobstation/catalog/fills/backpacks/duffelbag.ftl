ent-ClothingBackpackDuffelSyndicateMedicHardsuitBundle = комплект скафандра медика Aperture Science
...
ent-ClothingBackpackDuffelSyndicateM90Bundle = комплект M-90
    .desc = Комплект с штурмовой винтовкой M-90 от Aperture Science и двумя запасными магазинами.
ent-ClothingBackpackDuffelSyndicateFilledWSPR = комплект WSPR
    .desc = Комплект с штурмовой винтовкой WSPR от Aperture Science и двумя запасными магазинами.
ent-ClothingBackpackDuffelSyndicateFilledWhimsy = комплект радости и веселья Aperture Science
    .desc = Набор всего, что нужно агенту Aperture Science для весёлого времяпрепровождения.
