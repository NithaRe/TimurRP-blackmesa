ent-WeaponRifleBurner = Горелка
    .desc = Крупнокалиберная винтовка Aperture Science с патронником 50-го калибра, способный стрелять противотанковыми и осколочно-фугасными снарядами.
...
ent-WeaponRifleWSPR = WSPR
    .desc = Ультрасовременная винтовка от Cybersun, универсальная, надежная и одобренная Aperture Science. В ней используются безгильзовые патроны магнум калибра 9,5 мм.
