...
ent-PinpointerGeneric = универсальный пинпоинтер
    ...
    .suffix = Админ
ent-PinpointerStationGoob = пинпоинтер комплекса
    .desc = Ручное устройство слежения, которое отслеживает все близлежащие комплекса. Держите вертикально для сохранения точности.
...
ent-PinpointerSyndicateNuclearFission = пинпоинтер Оперативников HECU
    .desc = Создано специально для миссий Оперативников HECU, чтобы найти ядерную бомбу!
