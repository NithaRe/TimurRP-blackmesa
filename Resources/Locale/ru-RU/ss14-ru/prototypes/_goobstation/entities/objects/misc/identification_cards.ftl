...
ent-BlueshieldIDCard = ID-карта Синего Щита
    .desc = { ent-IDCardStandard.desc }
ent-NanotrasenRepresentativeIDCard = ID-карта инспектора Black Mesa
    .desc = { ent-IDCardStandard.desc }
ent-NanotrasenCareerTrainerIDCard = ID-карта наставника ЦК
    .desc = { ent-IDCardStandard.desc }
ent-ExecutiveIDCard = карта доступа руководителя
    .desc = Сотрудники Black Mesa, по закону, обязаны прослушивать сообщения пользователей при помощи одного из этих устройств. Кроме того, программа способна переопределять блокировки доступа на большинстве устройств.
...
ent-CentcomIDCardNavyCaptain = ID-карта руководителя комплекса ВКС
    .desc = { ent-IDCardStandard.desc }
...
ent-HighCommandIDCard = ID-карта высшего командования
    .desc = Особенно роскошная карта Aperture Science. Встроенный взломщик доступа позволяет открыть почти любую дверь.
