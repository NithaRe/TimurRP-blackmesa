...
ent-MechMaulerSyndie = Маулер
    .desc = Модифицированный "Мародер", используемый Aperture Science, который не так маневренен, как "Темный Гигакс", но компенсирует это броней и огневой мощью. На обратной стороне брони есть надпись "Cybersun Inc".
