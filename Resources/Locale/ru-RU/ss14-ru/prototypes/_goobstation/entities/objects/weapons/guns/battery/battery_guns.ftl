...
ent-MiniatureEnergyCrossbow = небольшой энергетический арбалет
    .desc = Энергетический арбалет Aperture Science, маленький, бесшумный и смертоносный.
...
ent-WeaponDisablerSyndicate = станнер Aperture Science
    .desc = Продвинутый станнер, созданный на основе прототипа Black Mesa. Хоть ему и не хватает мощности, это компенсируется самозаряжающейся батареей.
