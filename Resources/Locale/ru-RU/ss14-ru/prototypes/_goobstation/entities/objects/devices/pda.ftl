...
ent-NanotrasenRepresentativePDA = КПК представителя Black Mesa
    .desc = Дьявол кроется в деталях.
ent-TrainerPDA = КПК наставника
    .desc = Стандартный КПК наставника Black Mesa
ent-NavyCaptainPDA = КПК руководителя комплекса ВКС
    .desc = Дьявол кроется в деталях.
...
ent-InspectorPDA = КПК ревизора.
    .desc = { ent-NavyCaptainPDA.desc }
ent-SyndiPDANukie = КПК Aperture Science
    .desc = Ладно, пришло время стать продуктивным рабоч... о, круто, я плохой парень, пришло время убивать всех!
ent-HighCommandPDA = КПК офицера Aperture Science
    .desc = Обычный КПК Aperture Science, украшенный позолоченными символами. Его владелец явно занимает более высокое положение.
