ent-PosterLegitGoobWorkHard = Работай усердно
    .desc = Если будешь работать достаточно усердно, ТЫ сможешь получить собственный Black Mesa Plunger Plus! Только выживи достаточно долго, чтобы забрать его!..
...
ent-PosterLegitGoobSuperMatter = Супер-материя
    .desc = Black Mesa становится всё креативнее с мотивационными плакатами. Использовать причину смерти тысяч людей как источник мотивации? Гениально. Вот бы это ещё работало...
ent-PosterLegitGoobWatching = Всегда наблюдает
    .desc = Хорошее напоминание, что ИИ комплекса следит за безопасностью, уничтожая всякую личную жизнь! Разве тебе не приятно, что он, скорее всего, сейчас смотрит прямо на тебя?
...
ent-PosterLegitGoobSmokeBreak = Перерыв на курение
    .desc = Постер, напоминающий о «оптимальном» времени для курительных перерывов, одобренных Black Mesa. Время считалось по офицеру безопасности, который якобы выкуривал около 500 сигарет за 5 минут. Недавно время увеличили на 10 минут по просьбе руководитель комплексаов комплекса. Цвет фона слегка раздражает, но ты точно не знаешь почему.
...
ent-PosterLegitGoobBigBrotherAI = ИИ видит всё
    .desc = Постер напоминает, что твои секреты не скрыты от ИИ комплекса.
ent-PosterLegitGoobDurkPlush = Реклама плюшевого Дурка
    .desc = Постер с изображением плюшевого персонажа, который скоро появится в комплексе рядом с тобой.
...
ent-PosterLegitGoobNTRAdvert = Рекрутинг представителей NT
    .desc = Постер с объявлением о вакансиях представителей Black Mesa, может, стоит подать заявку.
