ent-ComputerNTRTasks = консоль заданий ПNT
    .desc = Терминал, предоставляющий доступ к миссиям Представителя Black Mesa. Ваша преданность будет вознаграждена. Выполняйте задания, копите очки лояльности и тратьте их на эксклюзивные привилегии ПNT.
