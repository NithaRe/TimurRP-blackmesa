...
ent-SpawnHumanHereticArmor = спавнер еретик (броня)
    .suffix = DEBUG
    .desc = { ent-MarkerBase.desc }
ent-SpawnMobHumanCaptainHardsuit = спавнер руководитель комплекса (скафандр)
    .suffix = DEBUG
    .desc = { ent-MarkerBase.desc }
ent-SpawnMobHumanCaptainModsuit = спавнер руководитель комплекса (MOD)
    .suffix = DEBUG
    .desc = { ent-MarkerBase.desc }
ent-SpawnMobHumanCaptainDebug = спавнер руководитель комплекса (броня)
    .suffix = DEBUG
    .desc = { ent-MarkerBase.desc }
