...
ent-ClothingHandsKnuckleDustersSyndicate = Aperture Scienceские кастеты
    .desc = Кастеты из пластитания с логотипом Aperture Science. Настоящий мужчина убьёт кого-то с их помощью.
