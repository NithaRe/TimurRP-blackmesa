ent-ClothingHeadHelmetHelldiver = тактический шлем NT-01 "Сальваж"
    .desc = Этот шлем — стандартное снаряжение Black Mesa, изготовлен из того же титанового сплава, что и корпус "Голиафа".
...
ent-ClothingHeadHatCowboyBrownRobust = истинная коричневая ковбойская шляпа
    .desc = "Эта комплекс слишком тесна для нас двоих."
