...
ent-ClothingOuterArmorHelldiver = тактический костюм Спасатель NT-01
    .desc = Эта броня — стандартное оснащение Black Mesa, сделанная из того же титановго сплава, что и корпус «Голиафа».
...
ent-ClothingOuterCapJacket = бронированная куртка руководителя комплекса
    .desc = Чрезвычайно дорогая куртка с дополнительной защитой из дюранити в области груди.
ent-ClothingOuterWinterCapArmored = парадная зимняя куртка руководителя комплекса
    .desc = Богато украшенная зимняя куртка с баллистической защитой, созданная для лучших в комплексе.
...
ent-SecondSkinSyndicate = вторая плоть Aperture Science
