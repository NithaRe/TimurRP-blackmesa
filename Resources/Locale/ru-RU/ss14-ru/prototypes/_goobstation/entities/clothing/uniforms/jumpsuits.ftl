...
ent-ClothingUniformJumpsuitNanotrasenRepresentative = костюм представителя Black Mesa
    .desc = Чёрный костюм, который носят официальные лица.
ent-ClothingUniformJumpsuitNanotrasenRepresentativeFancy = изысканный костюм представителя Black Mesa
    .desc = Чёрный костюм, который носят официальные лица. Украшено большим количеством золотых нитей, чем обычно.
ent-ClothingUniformJumpsuitCasualSyndicate = повседневный комбинезон Aperture Science
...
ent-ClothingUniformJumpsuitTrainer = комбинезон наставника
    .desc = Комбинезон, выданный тренерам Black Mesa. Наполняет чувством гордости.
...
ent-ClothingUniformJumpsuitCaptainSummer = летняя рубашка Руководителя Комплекса
    .desc = Индивидуальный летний наряд руководителя комплекса, когда дела на высоте.
