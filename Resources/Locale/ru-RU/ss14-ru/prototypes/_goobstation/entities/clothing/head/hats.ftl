ent-ClothingHeadHatBeretEliteNavyOfficer = элитный берет офицера ЦентКом
    .desc = Тёмно-синий берет с серебряным щитом сил безопасности Black Mesa.
ent-ClothingHeadHatBeretNavyOfficer = берет офицера ЦентКом
    .desc = Чёрный берет с серебряным щитом сил безопасности Black Mesa.
ent-ClothingHeadHatBeretNavyCaptain = берет руководителя комплекса военно-космического флота
...
ent-ClothingHeadHatTrainer = шапка наставника
    .desc = Шапка, выданная карьерным тренерам Black Mesa. Делает вас стильным.
ent-ClothingHeadBeretTrainer = берет наставника
    .desc = Берет, выданный карьерным тренерам Black Mesa. Делает вас стильным.
...
ent-ClothingHeadHatCapcapSenior = фуражка старшего руководителя комплекса
    .desc = Величественная и стильная фуражка, которую носят старшие руководитель комплексаы. Сразу показывает комплекса, кто здесь главный!
    .suffix = НЕ МАППИТЬ
