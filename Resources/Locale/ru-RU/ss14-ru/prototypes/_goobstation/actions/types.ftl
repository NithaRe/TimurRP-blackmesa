ent-ActionActivateBluespaceLifeline = Блюспейс коридор
    .desc = Активирует имплант Блюспейс коридор, телепортируя вас далеко-далеко от комплекса. Вернуться назад не получится.
...
ent-ActionShowStationMap = Переключить карту комплекса
    .desc = Показать интерфейс карты комплекса.
...
ent-ActionActivateRedspaceLifeline = Редспейс коридор
    .desc = Активирует имплант Редспейс коридор, телепортируя вас далеко-далеко от комплекса. Вернуться назад не получится.
