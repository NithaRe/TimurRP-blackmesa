ent-ClothingEyesEyepatchMedical = медицинская повязка на глаз
    .desc = Используется космическими виабу, чтобы притвориться, что у них нет глаза, и членами персонала, которые реально потеряли глаз, чтобы притвориться, что он у них есть.
