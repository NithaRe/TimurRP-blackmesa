...
ent-MindRoleParadoxClone = Роль парадоксальный клон
    .desc = { ent-BaseMindRoleAntag.desc }
ent-MindRoleNukeops = Роль Оперативник HECU
    .desc = { ent-BaseMindRoleAntag.desc }
ent-MindRoleNukeopsMedic = Роль медик Оперативников HECU
    .desc = { ent-MindRoleNukeops.desc }
ent-MindRoleNukeopsCommander = Роль командир Оперативников HECU
    .desc = { ent-MindRoleNukeops.desc }
...
ent-MindRoleTraitor = Роль предатель
    .desc = { ent-BaseMindRoleAntag.desc }
ent-MindRoleTraitorReinforcement = Роль подкрепление Aperture Science
