...
ent-BodyBagSyndicate = красный мешок для тела
    .desc = Пластиковый мешок с символикой Aperture Science, предназначенный для хранения и транспортировки трупов, и предотвращения их гниения.
    .suffix = Aperture Science
ent-BodyBagSyndicateFolded = { ent-BodyBagSyndicate }
    .desc = { ent-BodyBagSyndicate.desc }
    .suffix = Сложенный, Aperture Science
