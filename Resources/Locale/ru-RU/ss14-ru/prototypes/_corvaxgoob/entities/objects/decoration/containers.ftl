...
ent-ShippingContainerNanotrasen = грузовой контейнер Black Mesa
    .desc = Контейнер стандартного размера для транспортировки больших объёмов грузов. На этом контейнере изображён логотип компании Black Mesa, и поэтому внутри может быть что угодно.
