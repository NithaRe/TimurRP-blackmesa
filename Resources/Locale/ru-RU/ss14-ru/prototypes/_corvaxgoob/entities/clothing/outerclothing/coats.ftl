...
ent-ClothingOuterCoatSecurityOvercoat = шинель службы безопасности
    .desc = Легкобронированная кожаная шинель, предназначенная для повседневной носки высокопоставленными офицерами. Имеет логотип компании Black Mesa Security.
...
ent-ClothingOuterCoatCaptain = торжественная куртка руководителя комплекса
    .desc = Руководительская торжественная куртка, инкрустированная золотом.
