...
ent-ClothingBackpackMessengerCaptain = барсетка руководителя комплекса
    .desc = Прочная сумка, изготовленная исключительно для офицеров Black Mesa.
ent-ClothingBackpackMessengerCentcomm = барсетка ЦентКом
    .desc = Прочная сумка Black Mesa для высокопоставленных чиновников. Пахент пролитым кофе.
...
ent-ClothingBackpackMessengerSyndicate = барсетка Aperture Science
