...
ent-ClothingBeltSyndieHolster = плечевая кобура Aperture Science
...
ent-ClothingBeltMilitaryWebbing = армейская РПС
    .desc = Ременно-плечевая система тактических ремней, которую носят абордажные группы Aperture Science.
