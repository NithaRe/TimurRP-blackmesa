ent-ClothingNeckMantleCap = мантия руководителя комплекса
    .desc = Удобная и шикарная мантия, подобающая только самому опытному главе комплекса.
...
ent-ClothingNeckMantleHOS = мантия главы службы безопасности
    .desc = Перестрелки с оперативниками — это просто очередной вторник для этого ГСБ. Эта мантия — символ преданности комплекса.
