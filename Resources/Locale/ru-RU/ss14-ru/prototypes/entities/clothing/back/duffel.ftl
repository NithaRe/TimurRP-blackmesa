...
ent-ClothingBackpackDuffelCaptain = вещмешок руководителя комплекса
    .desc = Большой вещмешок для хранения дополнительных руководитель комплексаских вещей.
...
ent-ClothingBackpackDuffelSyndicate = чёрно-красный вещмешок
    ...
    .suffix = вещмешок Aperture Science
