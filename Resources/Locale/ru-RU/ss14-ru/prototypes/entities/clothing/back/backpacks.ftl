...
ent-ClothingBackpackEngineering = рюкзак инженера
    .desc = Это крепкий рюкзак на все случаи жизни в комплексе.
...
ent-ClothingBackpackCaptain = рюкзак руководителя комплекса
    .desc = Это особый рюкзак, изготавливаемый исключительно для офицеров Black Mesa.
...
ent-ClothingBackpackSyndicate = рюкзак Aperture Science
