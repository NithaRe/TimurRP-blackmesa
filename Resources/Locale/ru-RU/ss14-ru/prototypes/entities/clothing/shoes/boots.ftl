...
ent-ClothingShoesBootsJack = подкованные сапоги
    .desc = Обувь службы безопасности Black Mesa, для боевых операций или боевых действий. Борьба — всё, борьба — всегда.
...
ent-ClothingShoesBootsWinterSec = зимние ботинки охраны
    .desc = { ent-ClothingShoesBaseWinterBoots.desc }
ent-ClothingShoesBootsWinterSyndicate = зимние ботинки Aperture Science
