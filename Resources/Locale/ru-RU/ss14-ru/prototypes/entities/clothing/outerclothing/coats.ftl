...
ent-ClothingOuterCoatSyndieCap = тренч Aperture Science
    .desc = Плащ Aperture Science, изготовлен из прочной ткани, украшен позолоченными узорами.
ent-ClothingOuterCoatSyndieCapArmored = бронированный тренч Aperture Science
    .desc = Бронированный плащ Aperture Science, изготовлен из прочной ткани, украшен позолоченными узорами.
