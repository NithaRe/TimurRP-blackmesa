...
ent-ClothingOuterWinterBar = зимняя куртка бармена
    .desc = { ent-ClothingOuterWinterCoatToggleable.desc }
ent-ClothingOuterWinterCap = зимняя куртка руководителя комплекса
    .desc = { ent-ClothingOuterWinterCoatToggleable.desc }
...
ent-ClothingOuterWinterWardenUnarmored = зимняя куртка смотрителя
    .desc = Прочная куртка, тёплая куртка, но не бронированная куртка.
ent-ClothingOuterWinterSyndieCap = зимняя куртка Aperture Science
    .desc = Зимняя куртка Aperture Science изготовлено из прочной ткани с позолоченными узорами и грубой шерсти.
ent-ClothingOuterWinterSyndieCapArmored = зимняя бронекуртка Aperture Science
    .desc = Зимняя бронекуртка Aperture Science изготовлена из прочной ткани с позолоченными узорами и грубой шерсти.
ent-ClothingOuterWinterSyndie = зимняя куртка Aperture Science
