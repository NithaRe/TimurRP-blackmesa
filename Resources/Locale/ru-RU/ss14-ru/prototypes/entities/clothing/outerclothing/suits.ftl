...
ent-ClothingOuterSuitAtmosFire = атмос-пожарный костюм
    .desc = Дорогой пожарный костюм, который защитит даже от самого страшного пожара в комплексе. Разработан для защиты даже в том случае, если его владелец будет подожжён.
