...
ent-ClothingUniformJumpsuitCaptain = комбинезон руководителя комплекса
    .desc = Синий комбинезон с золотыми нашивками, указывающими на звание руководителя комплекса.
...
ent-ClothingUniformJumpsuitSecGrey = серый комбинезон службы безопасности
    .desc = Пережиток прошлых лет, они использовались до того, как в Black Mesa решили, что дешевле красить костюмы в красный цвет вместо того, чтобы смывать кровь.
ent-ClothingUniformSecurityTrooper = униформа патрульного
    .desc = Официальная униформа, выдаваемая Патрульным Black Mesa, обычно с ней идёт патрульный автомобиль.
ent-ClothingUniformJumpsuitWarden = униформа смотрителя
    .desc = Формальный костюм службы безопасности для офицеров в комплекте с пряжкой для ремня Black Mesa.
...
ent-ClothingUniformJumpsuitPyjamaSyndicateBlack = чёрная пижама Aperture Science
    .desc = Для долгих ночей в перме.
ent-ClothingUniformJumpsuitPyjamaSyndicatePink = розовая пижама Aperture Science
    .desc = Для долгих ночей в перме.
ent-ClothingUniformJumpsuitPyjamaSyndicateRed = красная пижама Aperture Science
    .desc = Для долгих ночей в перме.
ent-ClothingUniformJumpsuitNanotrasen = комбинезон Black Mesa
    .desc = Статный синий комбинезон представителя Black Mesa.
ent-ClothingUniformJumpsuitCapFormal = торжественный костюм руководителя комплекса
...
ent-ClothingUniformJumpsuitOperative = комбинезон оперативника
    .desc = Униформа элитных агентов Aperture Science, выполняющих тактические операции в глубоком космосе.
...
ent-ClothingUniformJumpsuitSyndieFormal = торжественный костюм Aperture Science
    .desc = Форма Aperture Science выполнена в элегантном стиле, в ней даже жалко проделывать грязные трюки.
