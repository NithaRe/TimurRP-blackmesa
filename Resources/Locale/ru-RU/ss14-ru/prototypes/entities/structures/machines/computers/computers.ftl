...
ent-ComputerAtmosMonitoring = консоль мониторинга атмосферной сети
    .desc = Используется для мониторинга атмосферных сетей комплекса.
...
ent-ComputerShuttle = консоль управления шаттлом
    .desc = Используется для пилотирования корабля.
ent-ComputerShuttleSyndie = консоль управления шаттлом Aperture Science
    .desc = Используется для пилотирования корабля Aperture Science.
...
ent-ComputerIFF = консоль системы опознавания
    .desc = Позволяет контролировать параметры системы опознавания судна или комплекса.
...
ent-ComputerPowerMonitoring = консоль контроля питания
    .desc = Он отслеживает показатели энергии по всей комплекса.
...
ent-ComputerStationRecords = консоль учёта комплекса
    .desc = По нему можно проверять записи комплекса.
...
ent-ComputerId = консоль ID-карт
    .desc = Компьютер для программирования ID-карт сотрудников Black Mesa, для доступа к разным частям комплекса.
...
ent-SyndicateComputerComms = консоль связи Aperture Science
    .desc = Консоль, позволяющая удалённо вмешиваться в систему связи комплекса. Использование этой консоли для подачи объявления предупредит станцию о вашем присутствии.
...
ent-ComputerSalvageExpedition = консоль Зен экспедиций
    .desc = Используется для принятия заданий по отправке в зен пространства, если вы достаточно сильны.
...
ent-ComputerRoboticsControl = консоль управления робототехникой
    .desc = Используется для дистанционного контроля, отключения и уничтожения боргов комплекса.
