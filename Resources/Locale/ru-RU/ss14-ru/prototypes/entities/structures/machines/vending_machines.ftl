...
ent-VendingMachineSeedsUnlocked = МегаРаздатчик Семян
    .desc = Для тех случаев, когда семена нужны срочно. Лучший ассортимент семян в комплексе!
...
ent-VendingMachineGames = Безобидные развлечения
    .desc = Выдаёт вещи, которые руководитель комплекса и глава персонала, скорее всего, не оценят, если вы будете развлекаться с ними вместо своей работы...
...
ent-VendingMachineSyndieDrobe = ApertureШкаф
    .desc = Шкаф-машина, закодированная Aperture Science, содержит элитную экипировку для различных операций.
...
ent-VendingMachineChemicalsSyndicate = ApertureСоки
    .desc = Надеюсь, не из свежевыжатых Aperture Science-овцев?
