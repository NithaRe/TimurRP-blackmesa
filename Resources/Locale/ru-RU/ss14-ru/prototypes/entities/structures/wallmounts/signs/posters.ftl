...
ent-PosterContrabandRIPBadger = Спите спокойно, барсуки
    .desc = Этот провокационный плакат рассказывает о геноциде, устроенном Black Mesa на космической станции, полной барсуков.
...
ent-PosterLegitNoERP = Скажи "НЕТ" ЕРП!
    .desc = Этот плакат напоминает экипажу, что эротика и порнография запрещены на станциях "Black Mesa".
...
ent-PosterLegitThereIsNoGasGiant = Газового гиганта не существует
    .desc = Black Mesa распространила плакаты, подобные этому, по всем станциям, напоминая, что слухи о газовом гиганте недостоверны.
