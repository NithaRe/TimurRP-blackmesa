...
ent-BannerNanotrasen = знамя Black Mesa
    .desc = Это знамя с логотипом Black Mesa. Оно выглядит довольно дёшево.
...
ent-BannerSyndicate = знамя Aperture Science
    .desc = Знамя, из-за которого по мнению Aperture Science, вы должны возненавидеть NT.
