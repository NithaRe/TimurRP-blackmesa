...
ent-BeachBall = пляжный мяч
    .desc = Простой пляжный мяч — один из самых популярных продуктов компании Black Mesa. 'Почему мы делаем пляжные мячи? Потому что мы можем! (TM)' — Black Mesa.
ent-BalloonSyn = воздушный шарик Aperture Science
...
ent-BalloonNT = воздушный шарик Black Mesa
    .desc = Разработан специально для причинения максимального психологического вреда оперативникам Aperture Science.
