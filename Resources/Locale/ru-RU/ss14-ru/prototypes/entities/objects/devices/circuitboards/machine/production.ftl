...
ent-PowerCageRechargerCircuitboard = зарядник энергоячеек (машинная плата)
    ...
    .suffix = { ent-BaseMachineCircuitboard.suffix }
ent-BorgChargerCircuitboard = комплекс зарядки боргов (машинная плата)
    .desc = Печатная плата комплекса зарядки боргов.
    .suffix = { ent-BaseMachineCircuitboard.suffix }
...
ent-TurboItemRechargerCircuitboard = турбозарядник (машинная плата)
    ...
    .suffix = { ent-BaseMachineCircuitboard.suffix }
ent-SubstationMachineCircuitboard = подкомплекс (машинная плата)
    .desc = Печатная плата.
    .suffix = { ent-BaseMachineCircuitboard.suffix }
ent-DawInstrumentMachineCircuitboard = цифровая звуковая рабочая комплекс (машинная плата)
    .desc = { ent-BaseMachineCircuitboard.desc }
    .suffix = { ent-BaseMachineCircuitboard.suffix }
