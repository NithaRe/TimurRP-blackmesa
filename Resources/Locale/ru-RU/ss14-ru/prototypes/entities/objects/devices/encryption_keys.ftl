...
ent-EncryptionKeyStationMaster = ключ шифрования руководства комплекса
    .desc = Ключ шифрования, используемый боссами комплекса.
ent-EncryptionKeyCentCom = ключ шифрования центрального командования
    .desc = Ключ шифрования, используемый боссами руководителя комплекса.
ent-EncryptionKeyCommand = ключ шифрования командования
    .desc = Ключ шифрования, используемый боссами персонала.
...
ent-EncryptionKeyBinarySyndicate = ключ двоичного перевода
    .desc = Ключ шифрования Aperture Science, используемый для преобразования двоичного кода, используемого синтетиками.
