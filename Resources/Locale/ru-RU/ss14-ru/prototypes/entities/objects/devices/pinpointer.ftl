...
ent-PinpointerSyndicateNuclear = пинпоинтер Aperture Science
    .desc = Изготовлен специально для миссий Оперативников HECU, получите этот диск!
...
ent-PinpointerStation = пинпоинтер комплекса
