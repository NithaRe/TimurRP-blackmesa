...
ent-HolofanProjectorBorg = встроенный атмос голопроектор
    .desc = Не позволяет идиотам причинить ещё больше вреда персоналу во время чрезвычайных ситуаций. Установлен напрямую в инженерного борга. Перезаряжается со временем.
