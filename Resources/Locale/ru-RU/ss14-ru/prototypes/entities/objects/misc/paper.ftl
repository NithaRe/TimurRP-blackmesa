...
ent-PaperCaptainsThoughts = размышления руководителя комплекса
    .desc = Страница из дневника руководителя комплекса. В роскошном лавандовом цвете.
...
ent-NukeCodePaperStation = { ent-NukeCodePaper }
    .suffix = Только комплекс
    .desc = { ent-NukeCodePaper.desc }
ent-TraitorCodePaper = кодовое слово Aperture Science
    .desc = Раскрытое кодовое слово, с помощью которого можно связаться с Aperture Science.
ent-AllTraitorCodesPaper = реестр кодовых слов Aperture Science
    .desc = Реестр всех активных кодовых слов Aperture Science.
    .suffix = Адмемы
