...
ent-BookEngineersHandbook = Справочник инженера
    .desc = Справочник по инженерному делу, подготовленный Black Mesa.
ent-BookScientistsGuidebook = Справочник учёного
    .desc = Путеводитель по миру науки, подготовленный Black Mesa.
ent-BookSecurity = Безопасность 101
    .desc = Книга о безопасности в комплексе, подготовленная Black Mesa. Книга испачкана кровью. Похоже, что её больше использовали как оружие, чем как учебное пособие.
ent-BookHowToKeepStationClean = Как поддерживать чистоту в комплексе
...
ent-BookSpaceLaw = Корпоративный закон
    .desc = Набор правил Black Mesa для поддержания закона и порядка на своих космических комплексх.
