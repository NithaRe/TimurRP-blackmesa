...
ent-RadioImplant = имплант "радио"
    .desc = Этот имплант даёт доступ к радиочастоте Aperture Science без гарнитуры.
ent-UplinkImplant = имплант "аплинк"
    .desc = Этот имплант позволяет пользователю получить доступ к скрытому аплинку Aperture Science по желанию.
...
ent-DeathRattleImplant = имплант "предсмертный хрип"
    .desc = Этот имплант сообщит по радиоканалу Aperture Science, если пользователь окажется в критическом состоянии или умрёт.
...
ent-MindShieldImplant = имплант "Щит разума"
    .desc = Этот имплант обеспечит лояльность к Black Mesa и предотвратит использование устройств контроля разума.
