...
ent-SoapNT = мыло
    .desc = Брусок мыла бренда Black Mesa. Пахнет плазмой.
ent-SoapDeluxe = мыло
...
ent-SoapletSyndie = обмылок
    .desc = Маленький кусочек мыла Aperture Science.
...
ent-SoapBorg = мыло
    .desc = Брусок мыла бренда Black Mesa. Пахнет плазмой и машинами.
