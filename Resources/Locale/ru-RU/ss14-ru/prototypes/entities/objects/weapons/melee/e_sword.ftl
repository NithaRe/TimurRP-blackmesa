...
ent-CyborgEnergySwordDouble = { ent-EnergySwordDouble }
    .desc = Стажеры из командования Aperture Science решили, что одного клинка на энергетическом мече недостаточно. Специальная разработка для боргов Aperture Science.
