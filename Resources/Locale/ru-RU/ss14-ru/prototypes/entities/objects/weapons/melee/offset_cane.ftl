...
ent-OffsetCaneNT = трость Black Mesa
    .desc = Стандартная трость Black Mesa, со смещённым центром тяжести и логотипом компании. Любима теми, кто предпочитает более корпоративный вид.
