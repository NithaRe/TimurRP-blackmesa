...
ent-WeaponAntiqueLaser = антикварный лазерный пистолет
    .desc = Это антикварный лазерный пистолет. Вся работа выполнена с высочайшим качеством. Он украшен рукояткой из красного дерева и хромированной филигранью. Объект устрашает энергетическими всплесками. На нём изображены капитан и клоун. Клоун мёртв. Руководитель Комплекса принимает героическую позу.
    .suffix = Пистолет
