...
ent-WeaponLaserCarbine = лазерная винтовка
    .desc = Предпочитается службой безопасности Black Mesa за дешевизну и простоту использования.
    .suffix = Винтовка
...
ent-WeaponPulsePistol = импульсный пистолет
    .desc = Новейший энергетический пистолет, предпочитаемый оперативниками Black Mesa в качестве запасного оружия.
    .suffix = Пистолет
ent-WeaponPulseCarbine = импульсный карабин
    .desc = Высокотехнологичный энергетический карабин, который предпочитают оперативники ОБР Black Mesa.
    .suffix = Винтовка
...
ent-WeaponAntiqueLaser = антикварный лазерный пистолет
    .desc = Это антикварный лазерный пистолет. Вся работа выполнена с высочайшим качеством. Он украшен рукояткой из красного дерева и хромированной филигранью. Объект устрашает энергетическими всплесками. На нём изображены руководитель комплекса и клоун. Клоун мёртв. Руководитель Комплекса принимает героическую позу.
    .suffix = Пистолет
