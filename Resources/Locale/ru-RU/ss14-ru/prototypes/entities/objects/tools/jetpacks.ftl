...
ent-ActionToggleJetpack = Переключить джетпак
    .desc = Переключить джетпак, позволяющий с лёгкостью передвигаться вне комплекса.
...
ent-JetpackCaptain = джетпак руководителя комплекса
    .suffix = Пустой
    .desc = { ent-BaseJetpack.desc }
ent-JetpackCaptainFilled = джетпак руководителя комплекса
    .suffix = Полный
