...
ent-CigPackSyndicate = пачка трав Интердайн
    .desc = Элитные сигареты для элитных агентов Aperture Science. Насыщенные лекарствами, когда вам нужно больше, чем просто успокоить нервы.
ent-CigPackMixedMedical = пачка пропитанных сигарет Дэна
    .desc = Дискаунтер Дэна работал с химическим подразделением компании Black Mesa в области утилизации избытка химикатов, НАСЛАЖДАЙТЕСЬ.
    .suffix = Лечебные
