...
ent-RandomHumanoidChallengeCargoTechnician = жертва катастрофы грузчик роль призрака
    .suffix = ЧЕЛЛЕНДЖ
    .desc = { ent-RandomHumanoidChallengeVictimCaptain.desc }
ent-RandomHumanoidSyndieSoldierTeamLeader = Aperture Science руководитель роль призрака
    .desc = { "" }
ent-RandomHumanoidSyndieSoldier = Aperture Science солдат роль призрака
    .desc = { "" }
ent-RandomHumanoidSyndieVisitor = Aperture Science жертва катастрофы роль призрака
    .desc = { "" }
ent-RandomHumanoidPirateScooner = пират член персонала роль призрака
    .suffix = scooner
    .desc = { "" }
ent-RandomHumanoidPirateCaptainScooner = пират руководитель комплекса роль призрака
    .suffix = scooner
    .desc = { "" }
