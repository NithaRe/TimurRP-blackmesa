...
ent-MobCockroach = таракан
    .desc = Эта комплекс просто кишит насекомыми.
ent-MobGlockroach = ТТаракан
    .desc = Эта комплекс просто кишит на- О БОЖЕ, У ЭТОГО ТАРАКАНА ПИСТОЛЕТ!!!
    .suffix = Адмемы
...
ent-MobBaseAncestor = генетический предок
    .desc = Генетический бипедальный предок... э-э... чего-то. Да, в комплексе определённо есть что-то, произошедшее от этого, чем бы оно ни было.
...
ent-MobBaseSyndicateMonkey = обезьяна
    .desc = Новая церковь неодарвинистов действительно верит, что КАЖДОЕ животное произошло от обезьяны. На вкус они как свинина, а убивать их весело и приятно.
    .suffix = Aperture Science, Базовый
...
ent-MobGrenadePenguin = пингвин гренадёр
    .desc = Маленький пингвин с гранатой на шее. Заготавливается Aperture Science на неблагоприятных ледяных планетах.
ent-MobSnake = змея
