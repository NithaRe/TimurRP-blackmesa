...
ent-MobPaperwork = Пэйперворк
    .desc = Устроился на новую работу по сортировке книг в библиотеке после того, как его перевели с Космической комплекса 13. Он, похоже, очень медленно справляется с этой работой.
ent-MobWalter = Уолтер
    .desc = Он обожает химию и угощения. Уолтер.
ent-MobPossumMorty = Морти
    .desc = Обитатель комплекса, Виргинский опоссум. Чувствительный, но стойкий парень.
