...
ent-HijackShuttleObjective = Завладейте эвакуационным шаттлом
    .desc = Улетите на шаттле свободным и без лояльного экипажа Black Mesa на борту. Используйте ЛЮБЫЕ доступные вам методы. Агенты Aperture Science, враги Black Mesa и заложники в наручниках могут оставаться на шаттле живыми. Игнорируйте помощь от кого-либо, кроме агента поддержки.
