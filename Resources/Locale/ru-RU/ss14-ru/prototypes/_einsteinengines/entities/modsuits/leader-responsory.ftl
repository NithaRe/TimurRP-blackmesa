...
ent-ClothingModsuitHelmetResponsoryLeader = шлем скафандра лидера ОБР
    .desc = Передовой шлем, разработанный Black Mesa для скафандра лидера ОБР. Имеет встроенный ИЛС.
ent-ClothingModsuitChestplateResponsoryLeader = нагрудная пластина скафандра лидера ОБР
    .desc = Передовой нагрудник, разработанный Black Mesa для скафандра лидера ОБР. Оснащён сервоприводами для снижения нагрузки.
