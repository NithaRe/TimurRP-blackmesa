...
ent-ClothingHeadEnvirohelmCaptain = экошлем руководителя комплекса
    .desc = Специальный герметичный шлем, предназначенный для руководителя комплекса.
...
ent-ClothingHeadEnvirohelmAncientVoid = NTSRA экошлем
    .desc = Из модифицированного костюма NTSRA, первый экошлем для плазмалюдей, разработанный Black Mesa.
...
ent-ClothingHeadEnvirohelmVirology = экошлем вирусолога
    .desc = Шлем, носимый самыми безопасными людьми в комплексе, полностью невосприимчивыми к создаваемым ими монстрам.
...
ent-ClothingHeadEnvirohelmNanotrasenRepresentative = экошлем представителя Black Mesa
    .desc = Чёрный экошлем для представителя Black Mesa с чёрными и золотыми акцентами.
