...
ent-ClothingUniformEnvirosuitCaptain = экокостюм руководителя комплекса
    .desc = Синий экокостюм с золотыми отметками, обозначающими ранг «Руководитель Комплекса».
...
ent-ClothingUniformEnvirosuitDetective = экокостюм детектива
    .desc = Проект для особенно изысканного плазмалюда, модифицированный Black Mesa для детективов.
...
ent-ClothingUniformEnvirosuitAncientVoid = NTSRA экокостюм
    .desc = Переделанный костюм NTSRA; этот неприспособленный для космоса костюм был первым экокостюмом Black Mesa для плазмалюдов.
ent-ClothingUniformEnvirosuitMedicalDoctor = экокостюм врача
    .desc = Костюм для более «плазменных» врачей комплекса.
...
ent-ClothingUniformEnvirosuitParamedic = экокостюм парамедика
    .desc = Костюм для плазмалюдов-парамедиков комплекса.
...
ent-ClothingUniformEnvirosuitVirology = экокостюм вирусолога
    .desc = Костюм для самых безопасных людей комплекса, полностью невосприимчивых к созданным ими монстрам.
...
ent-ClothingUniformEnvirosuitNanotrasenRepresentative = экокостюм представителя Black Mesa
