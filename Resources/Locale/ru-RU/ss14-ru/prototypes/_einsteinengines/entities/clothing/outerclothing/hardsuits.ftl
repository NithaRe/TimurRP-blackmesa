...
ent-ClothingOuterHardsuitCombatOfficer = боевой скафандр службы безопасности
    .desc = Специально разработанный боевой костюм, предназначенный для защиты пользователя от любого рода противников в условиях пониженного давления. Этот экземпляр отмечен символикой службы безопасности комплекса.
