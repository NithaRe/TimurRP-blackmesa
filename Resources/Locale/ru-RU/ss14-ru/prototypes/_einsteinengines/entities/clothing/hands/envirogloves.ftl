...
ent-ClothingHandsGlovesEnviroglovesHoP = экоперчатки главы персонала
    .desc = Скрывают эти вызывающе костлявые руки. Похоже на попытку сделать реплику перчаток руководителя комплекса.
ent-ClothingHandsGlovesEnviroglovesCaptain = экоперчатки руководителя комплекса
