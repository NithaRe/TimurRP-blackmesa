ent-CrateServiceJanitorialSupplies = ящик с уборочным инвентарём
    .desc = Победите копоть и грязь с Незаменимыми Припасами для Уборки от Black Mesa! Содержит три ведра, таблички мокрого пола и очищающие гранаты. Также содержит одну швабру, тряпку, щётку, чистящий спрей и мусорный пакет.
...
ent-CrateMousetrapBoxes = ящик мышеловок
    .desc = Мышеловки — на случай, когда орда мышей заполонила отделы комплекса. Используйте экономно... или нет.
ent-CrateServiceSmokeables = ящик табачных изделий
    .desc = Устали от быстрой смерти в комплексе? Закажите этот ящик и прокурите свой путь к кашляющей погибели!
...
ent-CrateJanitorBiosuit = ящик биозащитных костюмов уборщика
    .desc = Содержит 2 костюма биологической защиты, чтобы никакая зараза не отвлекала вас от уборки комплекса.
