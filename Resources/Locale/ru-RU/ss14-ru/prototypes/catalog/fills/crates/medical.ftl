...
ent-CrateVirologyBiosuit = ящик вирусологических биозащитных костюмов
    .suffix = Защищённый
    .desc = Содержит 2 костюма биологической защиты, чтобы никакая зараза не отвлекала вас от лечения персонала. Чтобы открыть, необходим уровень доступа Медицинский.
