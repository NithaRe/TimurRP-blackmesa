ent-CrateEmergencyExplosive = ящик сапёрного снаряжения
    .suffix = Защищённый
    .desc = Учёные обезумели? Что-то пикает за шлюзом? Купите сейчас и станьте героем, которого комплекс засл... Я имею в виду, в котором нуждается! (время в комплект не входит).
ent-CrateEmergencyFire = ящик пожарного снаряжения
    .desc = Только вы можете предотвратить пожар в комплексе. Вместе с двумя противопожарными костюмами, противогазами, фонариками, большими кислородными баллонами, огнетушителями и касками!
...
ent-CrateEmergencyInflatablewall = ящик надувных стен
    .desc = Три стопки надувных стен для случаев, когда металлические стены комплекса больше не удерживают атмосферу.
