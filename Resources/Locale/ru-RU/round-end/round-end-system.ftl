...
round-end-system-shuttle-auto-called-announcement = Процедура смены персонала начата. Шаттл вызван. Он прибудет через: { $time } { $units }.
round-end-system-shuttle-recalled-announcement = Эвакуационный шаттл был отозван.
round-end-system-shuttle-sender-announcement = комплекс
