...
comms-console-menu-broadcast-button-tooltip = Транслируйте своё сообщение на настенные экраны по всей комплекса. Примечание: помещается всего десять символов!
comms-console-menu-alert-level-button-tooltip = Изменение уровня угрозы комплекса. Применяется сразу после выбора.
...
comms-console-announcement-title-centcom = Командование Комплекса
comms-console-announcement-title-nukie = Оперативники HECU Aperture Science
