...
abductors-ghost-role-rules =
    ...
    Ваша цель — похищать людей с комплекса и заменять их органы на различные экспериментальные устройства,
...
abductor-role-greeting =
    Вы — профессиональный боевой учёный высокотехнологичной расы. Ваша задача — похищать людей, проводить над ними эксперименты, и возвращать живыми ради чистоты эксперимента. Вам невыгодно уничтожать станцию, убивать или помогать персоналу.
    Используйте + или +a в чате для общения в Разуме Абдукторов. Не перепутайте с Разумом Серых!
roles-antag-abductor-objective = Похищайте персонал комплекса и проводите над ними эксперименты!
abductor-victim-role-greeting = Вы видели то, чего не должны были увидеть. Вам тяжело оправиться после такого психологического сотрясения, что отразилось на вашем поведении. Но вам запрещено причинять явный вред персоналу. Мир должен узнать правду!
