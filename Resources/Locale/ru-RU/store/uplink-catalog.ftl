...
uplink-emag-desc = Он же ЕМАГ, визитная карточка Aperture Science. Устройство, способное взламывать различные станционные устройства. Перезаряжается автоматически.
