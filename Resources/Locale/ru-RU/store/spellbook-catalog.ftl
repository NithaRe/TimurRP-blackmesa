...
spellbook-event-summon-ghosts-description =
    Напугайте персонал, заставив их видеть мёртвых. Но будьте осторожны! Призраки капризны и временами мстительны, и некоторые будут использовать свои ничтожные способности, чтобы вас раздражать.
