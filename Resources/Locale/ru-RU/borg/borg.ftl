...
borg-type-generic-desc = Может всё, но одинаково не очень хорошо. Выполняйте различные случайные поручения в комплексе, или, быть может, окажите помощь научному отделу, который вас построил.
borg-type-generic-transponder = обычный борг
borg-type-engineering-name = Инженер
borg-type-engineering-desc = Помогайте команде инженеров в строительстве комплекса, ликвидации повреждений или исправлении проблем с электричеством и атмосферой.
...
borg-type-janitor-desc = Поддерживайте порядок в комплексе, убирайте пролитую жидкость, собирайте и правильно утилизируйте мусор, оставленный ленивыми членами персонала.
borg-type-janitor-transponder = борг-уборщик
borg-type-medical-name = Медик
borg-type-medical-desc = Оказывайте медицинскую помощь нуждающемуся персоналу в медотсеке или в опасных зонах, куда обычные парамедики не могут добраться.
borg-type-medical-transponder = борг-доктор
borg-type-service-name = Сервисный
borg-type-service-desc = Помогайте членам персонала в самых разных ситуациях - от подачи закусок и напитков до занятий ботаникой и развлечений.
