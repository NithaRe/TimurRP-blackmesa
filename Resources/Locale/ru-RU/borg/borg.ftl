...
borg-type-janitor-desc = Поддерживайте порядок в комплексе, убирайте пролитую жидкость, собирайте и правильно утилизируйте мусор, оставленный ленивыми членами экипажа.
